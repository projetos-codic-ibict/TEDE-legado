...
$SEL="SELECT pfCod FROM TSPF WHERE pfCod='$pfCod' and tspfTipo='Autor' and tsIdentificador!='0'";
...
$inclusao_pf="pfNome='$pfNome',pfLattes='$pfLattes',pfCPF='$pfCPF',pfEmail='$pfEmail'";
$total_pf="UPDATE PessoaFisica SET $inclusao_pf WHERE pfCod='$pfCod'";
$inconteudo_pf=mysql_db_query($base, $total_pf, $conexao);
