        ...
        <tr> 
		  ...
		  ?>
		   ...
		   <tr> 
              ...
              <tr> 
                <td height="12" class="subMenuOver" onClick="location='inserir_aluno.php'"><a href="../Copy%20of%20tde_pos/inserir_aluno.php" class="linkpreto">&raquo;Inserir</a></td>
              </tr>
              <tr> 
              ...
              <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr> 
                          <td width="16%" class="txtBold">Nome </td>
                        ...
                        <tr> 
                          <td class="txtBold"><a href="<? echo $linkLattes; ?>" target="_blank">Lattes 
                            </a></td>
                        ...
                        <tr> 
                          ...
                          <td><input name="pfCPF" type="text" <? if ($idioma_sistema=="pt-BR") {?>class="cpf" <? }else{?> class="req"<? } echo 'value="'.$pfCPF.'"'; $qtdCPFcampo=$qtdCPF+1; echo 'size="'.$qtdCPFcampo.'"'; echo 'maxlength="'.$qtdCPF.'"';  if ($CPFMascara=="Sim") {?>onKeyPress="CPF(this);" <? } ?>> </td>
                        </tr>
                        <tr> 
                        ...
                        <tr align="center" valign="middle" class="tdBiblioteca"> 
                          <td colspan="2" class="txtBold">Afilia&ccedil;&atilde;o</td>
                        </tr>
                        <tr> 
...
$SEL_pj1_RES=mysql_fetch_array($SEL_pj1_query);
				...
				$pjURL=$SEL_pj1_RES["pjURL"];
                        ...
                        <tr> 
                          ...
                          <td> 
                            ...
                            <input name="ApjCNPJ" type="text" <? if ($idioma_sistema=="pt-BR") {?>class="cnpj" <? }else{?> class="req"<? } echo 'value="'.$ApjCNPJ.'"'; $qtdCNPJcampo=$qtdCNPJ+1; echo 'size="'.$qtdCNPJcampo.'"'; echo 'maxlength="'.$qtdCNPJ.'"';  if ($CNPJMascara=="Sim") {?>onKeyPress="CNPJ(this);" <? } ?>> 
                            <? } ?>
                          </td>
                        </tr>
                        <tr> 
                ...
                <tr> 
                  <td align="right" valign="bottom"><input name="cod" type="hidden" class="input" value="Inserir"> 
                    <input name="Inserir" type="submit" class="botao" value="Inserir &raquo;"> 
                  </td>
                </tr>
              </table>
              <br>
