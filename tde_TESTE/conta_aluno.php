...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | P&oacute;s-Gradua&ccedil;&atilde;o | Verifica&ccedil;&atilde;o de Conta do Aluno</title>
<!-- InstanceEndEditable --> 
      ...
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  ?>
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='conta_aluno.php'"><a href="../Copy%20of%20tde_pos/conta_aluno.php" class="linkpreto">&raquo; 
                  Inserir</a></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td align="center" valign="middle">
                  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <tr> 
                        <td height="40" align="left"><? echo $com;?></td>
                      </tr>
                      <tr> 
                        <td height="60" align="left"><a href="Javascript:MM_openBrWindow('imprimir_conta_aluno.php?<? echo $c;?>&e=<? echo $e;?>&s=<? echo $s;?>','Maio23','scrollbars=yes,width=400,height=300')"> 
                          </a><a href="javascript:print()" class="linkpreto" onFocus="this.blur()">imprimir&nbsp;<img src="../tde_layout1/imagens/print.gif" hspace="3" border="0" align="absmiddle"></a></td>
                      </tr>
                    </table></td>
              </tr>
            </table>
...
require "biblioteca/inserir_contas.inc";
}
}
?>            <div>
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" valign="middle" class="tdPos"> 
                        <td colspan="2" class="txtBold">Conta Autor</td>
                      </tr>
                      <tr> 
                        <td colspan="2">Entre com as 3 primeiras letras do nome 
                          do autor </td>
                      </tr>
                      <form action="" method="post" name="form1">
                        <tr> 
                          <td width="8%" align="left"> <input name="busca" type="text" class="input"  size="4" maxlength="3" value="<? echo $busca; ?>"> 
                          </td>
                          <td><input name="Submit" type="submit" class="botao" value="Localizar &raquo;"></td>
                        </tr>
						...
						<? if ($busca!="" or $SpfCod!="") { ?>
                        <tr> 
                          <td> <span class="txtBold">Nome</span> </td>
				  ...
				  ?>
                              ...
                              <? 
					$SEL_pf="SELECT * FROM TSPF INNER JOIN PessoaFisica ON (TSPF.pfCod = PessoaFisica.pfCod) WHERE (PessoaFisica.pfNome like '$busca%' and TSPF.tspfDisponivel=1 and prCod=$SprCod)";
...
$SEL_pf_RES=mysql_fetch_array($SEL_pf_query);
				...
				$SEL_cn="SELECT * FROM Contas WHERE pfCod='$pfCod'";
...
/*
            ...
            <form action="" method="post" name="form1" onSubmit="return checkForm(this.name); return true;">
                      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        <tr align="center"> 
                          <td colspan="2"><?echo $erro;?></td>
                        </tr>
                        <tr class="tdPos"> 
                          <td height="18" colspan="2" align="center" valign="middle" class="txtBold">Validade 
                            da conta </td>
                        </tr>
                        <tr bgcolor="#FFFFFF"> 
                          <td class="txtBold">&nbsp;</td>
                        ...
                        <tr bgcolor="#FFFFFF"> 
                          <td width="12%" class="txtBold">In&iacute;cio</td>
                          <td width="88%"> <select name="cnDiaInicio" class="select" id="select">
                              <option value="<? echo $dia_a; ?>" selected><? echo $dia_a; ?></option>
                            ...
                            - 
                            <input name="cnAnoInicio" type="text" class="numero" id="cnAnoInicio" value="<? echo $ano_a; ?>" size="5" maxlength="4">
                            (AAAA)</td>
                        </tr>
                        <tr bgcolor="#FFFFFF"> 
                          <td class="txtBold">T&eacute;rmino</td>
                          <td> <select name="cnDiaTermino" class="select" id="select2">
                              <option value="<? echo $dia_a; ?>" selected><? echo $dia_a; ?></option>
                              <option value="01">01</option>
                              <option value="02">02</option>
                              <option value="03">03</option>
                            ...
                            - 
                            <input name="cnAnoTermino" type="text" class="numero" id="cnAnoTermino" value="<? $ano_t=$ano_a+$soma_ano; echo $ano_t; ?>" size="5" maxlength="4">
                            (AAAA)</td>
                        </tr>
                        <tr> 
                          <td class="txtBold">Bloquear</td>
                          <td><input name="cnBloqueado" type="radio" value="1" checked>
                            Sim 
                            <input name="cnBloqueado" type="radio" value="0">
                            N&atilde;o 
                            <input name="cnSenha" type="hidden" class="input" id="cnSenha2" value="<?
				  srand((double)microtime()*1000000);
				  $nome=rawurlencode($pfNome); 
				  $nome_aux=str_replace('%', '"abcdefghijklmnopqrstuvwxyz1234567890', $nome); 
				  $tam=strlen($nome_aux); 

$cnSenha=strtolower($nome_aux[(int)round($tam/5)].rand(0,9).$nome_aux[(int)round($tam/5*2)].rand(0,9).$nome_aux[(int)round($tam/5*3)].rand(0,9).$nome_aux[ (int)round($tam/5*4)].$nome_aux[(int)round($tam-1)]); 
				   echo $cnSenha; ?>" size="32" maxlength="30"></td>
                        </tr>
                        <tr> 
                          <td>&nbsp;</td>
                          <td><input name="cnTipo" type="hidden" class="input" id="cnTipo2" value="Revisor"> 
                        ...
                        <tr> 
                          <td>&nbsp;</td>
                          <td align="right" valign="bottom"> <input name="Inserir" type="submit" class="botao" id="Inserir" value="Inserir &raquo;"> 
                          </td>
                        </tr>
                      </table>
            </form>
