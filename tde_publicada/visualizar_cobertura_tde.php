...
$estiloTR="trResposta";
		...
		?>
		     ...
		     echo $idIdioma; ?>
                        ...
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="editar_cobertura_tde.php?cbCod=<? echo $cbCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="excluir_cobertura_tde.php?cod=Excluir&cbCod=<? echo $cbCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}}
