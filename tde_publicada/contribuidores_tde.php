...
require "../conexao/conexao.inc";
		  ...
		  if ($sucesso!="" or $erro!="") { ?>
            <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td height="32" align="center" valign="middle">  <? echo $sucesso; echo $erro;?> 
                </td>
              </tr>
            </table>
            <? } ?>
            ...
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr> 
                ...
                <td height="31" align="center" valign="middle">                  <?echo $erro1; echo $sucesso;?> 
              ...
              <tr class="tdBiblioteca"> 
                ...
                <td class="txtBold"><? echo $txContribuidoresInser; ?>: </td>
              </tr>

              <tr>

                <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="txt">
...
$cor="#F0F0F0";
		...
		?>
                    ...
                    <tr bgcolor="<? echo $cor; ?>"> 
                      ...
                      <td width="7%" class="txtBold"> <? echo $txNome; ?>:</td>

                      <td width="46%"><? echo $pfNome; ?></td>

                      <td width="6%" class="txtBold"><? echo $txTipo; ?>:</td>

                      <td width="29%"><? echo $tspfTipo; ?> 

                      <input name="pfCod" type="hidden" class="input" id="pfCod2" value="<? echo $pfCod; ?>"></td>
