		  ...
		  if ($sucesso!="" or $erro!="") { ?>
            ...
            <form action="" method="post" name="form" onSubmit="return checkForm(this.name); return true;" >
              <table width="90%" border="0" align="center" cellpadding="5" cellspacing="2" class="loginTable">
                ...
                <tr> 
                  <td height="20">&nbsp;</td>
                  <td> <input name="cod" type="hidden" class="input" value="Editar"> 
                    ...
                    <input name="asCod" type="hidden" class="input" id="asCod3" value="<? echo $asCod; ?>"> 
                    <input name="tabelaCNPQ" type="hidden" class="input" value="Sim"></td>
                </tr>
                <tr> 
                  <td height="20">&nbsp;</td>
                  <td>&nbsp;</td>
