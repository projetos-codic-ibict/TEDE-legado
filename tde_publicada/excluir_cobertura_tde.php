              ...
              <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td height="75%"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <td bgcolor="#FFFFFF"><? echo $cbCobertura; ?>
                        </td>
                      </tr>
                      <tr valign="bottom"> 
                        ...
                        <td height="43" valign="middle"><?
							...
							$SEL_id="SELECT * FROM Idiomas WHERE idIdiomaPais='$idioma_sistema' and idSigla='$cbIdioma'";
                      ...
                      <tr valign="bottom">
                        <td height="40"><input name="cod" type="hidden" class="input" value="Excluir">
                          ...
                          <input name="cbCod" type="hidden" class="input" value="<? echo $cbCod; ?>"></td>
                        <td height="40" align="right"><input name="Excluir" type="submit" class="botao" id="Excluir" value="<? echo $txExcluir; ?> &raquo;"></td>
                      </tr>
                    </table>
                    </td>
                </tr>
