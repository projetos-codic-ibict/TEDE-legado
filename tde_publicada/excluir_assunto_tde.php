            ...
            <form action="" method="post" name="form" onSubmit="return checkForm(this.name); return true;" >
              <table width="90%" border="0" align="center" cellpadding="5" cellspacing="2" class="loginTable">
                ...
                <tr> 
                  ...
                  <td class="txt"><? echo $asEsquema; ?></td>
                </tr>
                <tr> 
                  <td height="20"><strong class="txtBold"><? echo $txIdioma; ?></strong></td>
                  <td><?
							 
							$SEL_id="SELECT * FROM Idiomas WHERE idIdiomaPais='$idioma_sistema' and idSigla='$asIdioma'";
                      ...
                      <input name="asCod" type="hidden" class="input" value="<? echo $asCod; ?>"></td></tr>
                <tr> 
                  <td height="20">&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                <tr> 
                  <td height="20">&nbsp;</td>
                  <td align="right"><input name="Excluir" type="submit" class="botao" id="Editar3" value="<? echo $txExcluir; ?> &raquo;"></td>
                </tr>
              </table>
              <br>
            </form>
