                ...
                <tr> 
                  <td> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" valign="middle" class="tdBiblioteca"> 
                        <td height="14" colspan="5" class="txtBold"><? echo $txAssunto; ?></td>
                      </tr>
                      <?
require "../conexao/conexao.inc";
$estiloTR="tr";
...
$sel2="select * from Assunto where tsIdentificador=$VtsIdentificador ORDER BY asCod";
...
?>
                      <tr class="tdOperacoes"> 
                        <td height="14" colspan="5" class="txtBold"><? echo $txNenhumRegistroC; ?>.</td>
                      </tr>
                      <? } else { ?>
                      <tr> 
                        <td height="14" class="txtBold"><? echo $txAssunto; ?></td>
                        <td class="txtBold"><? echo $txEsquema; ?></td>
                        <td width="120" class="txtBold"><? echo $txIdioma; ?></td>
                      ...
                      <?
while ($sel2RESP!="") {
$asCod=$sel2RESP[asCod];
$asAssunto=$sel2RESP["asAssunto"];
$asIdioma=$sel2RESP["asIdioma"];
$asEsquema=$sel2RESP["asEsquema"];

 
$SEL_id="SELECT idIdioma FROM Idiomas WHERE idSigla='$asIdioma'";
...
$estiloTR="trResposta";
                      ...
                      <tr> 
                        <td class=<? echo $estiloTR; ?>><? echo $asAssunto; ?> 
                        </td>
                        <td class=<? echo $estiloTR; ?>><? echo $asEsquema; ?></td>
                        <td class=<? echo $estiloTR; ?>> 
                          <?
		   echo $idIdioma; ?>
                        </td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><? if ($asEsquema!="Tabela CNPQ") {?><a href="editar_assunto_tde.php?asCod=<? echo $asCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } else {?><a href="editar_areaCNPQ_tde.php?asCod=<? echo $asCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } ?></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><? if ($asEsquema!="Tabela CNPQ") {?><a href="excluir_assunto_tde.php?cod=Excluir&asCod=<? echo $asCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } ?></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}}
