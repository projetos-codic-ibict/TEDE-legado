...
require "biblioteca/alterar_cod_tde.inc";
      ...
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139" align="left" valign="top" class="subMenuBib"><? require "menu.php"; ?></td>
              ...
              <tr> 
                <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" class="txt">
                    ...
                    <tr class="tdAlternado"> 
                      <td width="18%"><span class="txtBold"><? echo $txObservacao; ?></span></td>
                      <td width="82%" height="18"><? echo $tsOBS; ?></td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                      <td height="18">&nbsp;</td>
                    ...
                    <tr> 
                      ...
                      <td><table width="100%"  border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
                          <tr> 
                              <td width="276"><? echo $txSeuEMailPodeSDPR; ?>? </td>
                            <td width="65"> 
		...
		?>
				  ...
				  ?>
                    ...
                    <tr> 
                      ...
                      <td height="18"><? echo $AttTitulo[0]; ?> </td>
                    </tr>
                    <tr> 
			...
			echo $SubAreaCNPQ;
				...
				?>
                    ...
                    <tr align="left" valign="top"> 
                      ...
                      <td height="18"><? echo $ArsResumo[0]; ?> </td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td class="tdAlternado"><table width="100%" border="0" cellpadding="3" cellspacing="3"  class="txt">
                    ...
                    <tr align="left" valign="top" class="txt"> 
                      ...
                      <td height="18"><? echo $AttTitulo[1]; ?> </td>
                    </tr>
                    <tr class="txt"> 
                      <td>&nbsp;</td>
                      <td height="18">&nbsp;</td>
                    ...
                    <tr align="left" class="txt"> 
                      <td colspan="2" bgcolor="#FFFFF0"><span class="txtBold"><? echo $txAssunto; ?></span></td>
                    </tr>
                    <tr align="left" valign="top" class="txt"> 
                        <td><span class="txtBold">&nbsp;&nbsp;&nbsp;<? echo $txPalavrasChave; ?></span></td>
                      <td height="18"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="txt">
...
if ($AasAssunto3[$i]!="") {
if ($tsIdiomaALT==$AasIdiomaAssunto3[$i]) {
echo $AasAssunto3[$i].";"; 
}else{
echo $AasAssunto3[$i]."[".$AasIdiomaAssunto3[$i]."];"; 
}
}
}
?>
                    ...
                    <tr class="txt"> 
                      <td align="left" valign="top"><span class="txtBold"><? echo $txResumo; ?><input name="tsIdentificador" type="hidden" class="input" id="tsIdentificador" value="<? echo $tsIdentificador; ?>">
                        </span></td>
                      <td height="18"><? echo $ArsResumo[1]; ?> </td>
                    </tr>
                </table></td>
              </tr>
          </table></div><br> </td>
