          ...
          <td height="100%" align="center" valign="top" class="tdConteudo">
		   ...
		   <form action="" method="post" name="webform" onSubmit="return checkForm(this.name); return true;">
             <? if ($Excluir!="") { ?>
                ...
                <tr> 
                  <td align="center" valign="middle"><p><span class="tituloSistema"> 
                    ...
                    <table align="right" cellpadding="4" cellspacing="0" class="txt">
                      <tr> 
                        <td align="center" valign="middle" class="botao" onClick="location='excluir_tde_publicada.php?excluir=Sim'" ><a href="excluir_tde_publicada.php?codExcluir=Sim&VtsIdentificador=<? echo $VtsIdentificador;?>&VpfCod=<? echo $VpfCod; ?>" class="menu"><? echo $txConfirmar; ?> 
                          &raquo; </a></td>
                      </tr>
                    </table>
              ...
              <? exit; }
				 if ($codExcluir!="") {
	  require "biblioteca/excluir_tde_publicada.inc";
	  exit;
	  }
	   require "../conexao/conexao.inc";
