      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td height="100%" valign="top" class="tdConteudo"> 
            <?
 require "../conexao/conexao.inc";
$selcb="select * from Cobertura where cbCod=$cbCod";
$selcb_query=mysql_db_query($base,$selcb,$conexao);
$selcbRESP=mysql_fetch_array($selcb_query);

$cbCod=$selcbRESP[cbCod];
$cbCobertura=$selcbRESP["cbCobertura"];
$cbIdioma=$selcbRESP["cbIdioma"];
		  ?>
            <?
              ...
              <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td height="75%"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr> 
                        <td height="58" bgcolor="#FFFFFF"><span class="txtBold"><? echo $txCobertura; ?></span></td>
                        <td bgcolor="#FFFFFF"><textarea name="cbCobertura" cols="40" rows="2" class="input" onChange="optional(this.form,this);" onKeyPress="optional(this.form,this);"><? echo $cbCobertura; ?></textarea> 
                        </td>
                      </tr>
                      <tr valign="bottom"> 
                        <td height="43" valign="middle"><span class="txtBold"><? echo $txIdioma; ?></span></td>
                        <td height="43" valign="middle"><select name="cbIdioma" class="input" onChange="optional(this.form, this);">
                              <?
							...
							?>
                              <option value="<? echo $idSigla; ?>" <? if ($cbIdioma==$idSigla) { echo "selected"; } ?>><? echo $idIdioma; ?></option>
                              <? 
						    $SEL_id_RES=mysql_fetch_array($SEL_id_query);
						   } ?>
                            </select></td>
                      ...
                      <tr valign="bottom">
                        <td height="40"><input name="cod" type="hidden" class="input" value="Editar">
                          <input name="VtsIdentificador" type="hidden" class="input" id="VtsIdentificador2" value="<? echo $VtsIdentificador; ?>">
                          <input name="VpfCod" type="hidden" class="input" id="VpfCod2" value="<? echo $VpfCod; ?>">
                          <input name="cbCod" type="hidden" class="input" id="cbCod2" value="<? echo $cbCod; ?>"></td>
                        <td height="40" align="right"><input name="Editar" type="submit" class="botao" id="Editar" value="<? echo $txAlterar; ?> &raquo;"></td>
                      </tr>
                    </table>
                    </td>
                </tr>
