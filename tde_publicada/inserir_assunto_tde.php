              ...
              <table width="90%" height="0%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td height="75%"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr> 
                          <td width="17%" align="left" valign="top" class="txtBold"><? echo $txAssunto; ?></td>
                          <td width="83%"><textarea name="asAssunto" cols="40" rows="2" class="txt" id="asAssunto"></textarea> 
                          </td>
                        </tr>
                        <tr> 
                          <td height="30" valign="middle" class="txtBold"><? echo $txEsquema; ?></td>
                          <td height="30" valign="middle"><input name="asEsquema" type="text" class="input" id="asEsquema" size="32" maxlength="100"></td>
                        </tr>
                        <tr> 
                          <td height="30" valign="bottom" class="txtBold"><? echo $txIdioma; ?></td>
                          <td height="30" valign="bottom"> <select name="asIdioma" class="select"><?							 
                        ...
                        <tr> 
                          ...
                          <td height="40" align="right" valign="bottom"><input name="cod" type="hidden" class="input" value="Inserir"> 
                            <input name="VtsIdentificador" type="hidden" class="input" id="VtsIdentificador" value="<? echo $VtsIdentificador; ?>"> 
                            <input name="VpfCod" type="hidden" class="input" id="VpfCod" value="<? echo $VpfCod; ?>"> 
                            <input name="Inserir" type="submit" class="botao" id="Inserir2" value="<? echo $txInserir; ?> &raquo;"></td>
                        </tr>
                      </table>
                  </td>
                </tr>
