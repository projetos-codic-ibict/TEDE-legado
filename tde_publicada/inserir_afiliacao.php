              ...
              <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td align="center" valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="txt">
                      ...
                      <tr align="center" bgcolor="<? echo $cor; ?>" class="tdBiblioteca"> 
                        <td colspan="3" class="txtBold"><? echo $txAfiliacao; ?></td>
                      </tr>
<?	         
...
?>
                      <tr bgcolor="<? echo $cor; ?>" class="txtBold"> 
                        ...
                        <td width="372">&nbsp;</td>
                        <td align="center"><? echo $txExcluir; ?></td>
                      </tr>
<?
while ($sel2RESP!="") {
...
?>
                      <tr bgcolor="<? echo $cor; ?>"> 
                        <td colspan="2"><? echo $VpjNome; ?></td>
                        <td width="39" align="center"><a href="inserir_afiliacao.php?cod=Excluir&pjCod=<? echo $pjCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}}
...
$SEL_pj1_RES=mysql_fetch_array($SEL_pj1_query);
				...
				$pjURL=$SEL_pj1_RES["pjURL"];
                      ...
                      <tr class="tdAlternado"> 
                          ...
                          <td>                          <? if ($SpjCod!="Nenhum") { echo  $pjCNPJ; } else {  
