              ...
              <tr> 
                <td align="center" valign="middle"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr valign="middle" class="tdBiblioteca"> 
                        <td colspan="5" align="center" class="txtBold"><? echo $txArquivo; ?></td>
                      </tr>
                      <?				  
$estiloTR="tr";
...
?>
                      <tr class="<? echo $estiloTR; ?>"> 
                        <td> <a href="<? echo $arURL;?>" target="_blank">
                          <?	echo "$arNomeArquivo";	?></a>
                        </td>
                        <td> 
...
$sel_laRESP=mysql_fetch_array($sel_la_query);
                        ...
                        <td width="50" align="center"><a href="alterar_arquivo.php?arCod=<? echo $arCod; ?>&tsIdentificador=<? echo $VtsIdentificador; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="Alterar direitos do arquivo" width="18" height="18" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center"><a href="inserir_arquivo.php?cod=Excluir&arCod=<? echo $arCod; ?>&tsIdentificador=<? echo $VtsIdentificador; ?>&arURL=<? echo $arURL; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <?
$sel2RESP=mysql_fetch_array($sel2_query);
}}
?>
			...
			<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr class="tdAlternado">
                ...
                <td><input name="laLegenda" type="text" class="input" size="50">
                    ...
                    <?
					$idioma_sistema_split=split("-",$idioma_sistema);
					$idioma_legenda_arquivo=strtoupper($idioma_sistema_split[0]);
					?>
                    <input name="laIdioma" type="hidden" class="input" value="<? echo $idioma_legenda_arquivo; ?>"> 
                  </td>
              </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
