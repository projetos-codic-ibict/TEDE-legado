...
require "biblioteca/alterar_contribuidores_tde.inc";
      ...
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  ?>
            ...
            <?
			  $SEL_tspf="SELECT tspfDisponivel FROM TSPF WHERE tsIdentificador=$VtsIdentificador and (tspfDisponivel='3' or tspfDisponivel='1')";
			...
			if ($SEL_tspf_RES=="") {
			  ?>
            <tr>
              <td height="14" class="subMenuOut" onClick="location='alterar_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'"> <a href="alterar_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txAlterar; ?></a></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            ...
            <?
			   require "../conexao/conexao.inc";
			  $SEL_pfCod="SELECT pfCod FROM TSPF WHERE tsIdentificador=$VtsIdentificador and tspfTipo<>'Autor'";
            $SEL_pfCod_query=mysql_db_query($base,$SEL_pfCod,$conexao);
            $SEL_pfCod_RES=mysql_fetch_array($SEL_pfCod_query);
			  if ($SEL_pfCod_RES=="") {
			  ?>
            <tr>
              <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='alterar_contribuidores.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="alterar_contribuidores.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkvermelho">&raquo; <? echo $txInserir; ?></a></td>
            </tr>
            <? } else { ?>
            <tr>
              <td height="12" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='alterar_contribuidores.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="alterar_contribuidores.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo;  <? echo $txInserir; ?>/<? echo $txExcluir; ?></a></td>
            </tr>
            <? } ?>
            <tr class="txt">
              <td height="14">&nbsp;</td>
            ...
            <tr class="txt">
              <td height="14" class="td"><span class="txtBold">&raquo; <? echo $txTipo; ?></span></td>
            </tr>
            <tr class="txt">
              <td height="14" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_tipos.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="inserir_tipos.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txVisualizar; ?></a></td>
            </tr>
            <tr class="txt">
              <td height="14">&nbsp;</td>
            </tr>
            <tr class="txt">
              <td class="td"><span class="txtBold">&raquo; <? echo $txArquivo; ?></span></td>
            </tr>
            <tr class="txt">
              <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_arquivo.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="inserir_arquivo.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txVisualizar; ?></a></td>
            </tr>
            <?  if ($SEL_pfCod_RES!="") { 
            ...
            <tr>
              <td class="td"><span class="txtBold">&raquo; <? echo $txObservacao; ?></span></td>
            </tr>
            <?
			  $SEL_obs="SELECT tsOBS, tsOBSDestino FROM Teses WHERE tsIdentificador=$VtsIdentificador";
            $SEL_obs_query=mysql_db_query($base,$SEL_obs,$conexao);
            $SEL_obs_RES=mysql_fetch_array($SEL_obs_query);
			$tsOBS=$SEL_obs_RES["tsOBS"];
			$tsOBSDestinoM=$SEL_obs_RES["tsOBSDestino"];
			$tsOBSPos_split=split("</POS>",$tsOBS);
$tsOBSPos=str_replace("<POS>Pós-graduação: ","",$tsOBSPos_split[0]);
$tsOBSPos_cat=split("CATALOGADOR>Catalogador:",$tsOBSPos);
if ($tsOBSPos_cat[1]!="") {
$tsOBSPos="";
}
			if ($tsOBSPos=="") {
			?>
            <tr class="txt">
              <td height="14" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="inserir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txInserir; ?></a></td>
            </tr>
            <? }else{ ?>
            <tr class="txt">
              <td height="14" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="inserir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txAlterar; ?></a></td>
            ...
            <tr class="txt">
              <td height="14" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>'"><a href="excluir_obs.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>" class="linkpreto">&raquo; <? echo $txExcluir; ?></a></td>
            </tr>
            <? } ?>
            <tr>
              <td class="td">&nbsp;</td>
            ...
            <tr>
              <td class="td"><span class="txtBold">&raquo; <? echo $txFinalizar; ?></span></td>
            </tr>
            <?
			  
			if ($tsOBS!="" and $tsOBSDestinoM=="A")  {
			  ?>
            <tr>
              <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='enviar_catalogar_obs_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>&OBS=Sim'"><a href="enviar_catalogar_obs_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>&OBS=Sim" class="linkvermelho">&raquo; <? echo $txEnviarOBSAutor; ?></a></td>
            </tr>
            <? } else  { 
			   
			  ?>
            <tr>
              <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='enviar_catalogar_obs_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>&catalogar=Sim'"><a href="enviar_catalogar_obs_tde.php?VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>&VprCod=<? echo $SprCod; ?>&catalogar=Sim" class="linkvermelho">&raquo; <? echo $txDisponibilizarBib; ?></a></td>
            </tr>
            <?  } } }?>
            <tr>
              <td class="td">&nbsp;</td>
            ...
            <tr>
              <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='sessao_fim.php?VtsIdentificador=<? echo $VtsIdentificador; ?>'"><a href="sessao_fim.php?VtsIdentificador=<? echo $VtsIdentificador; ?>" class="linkpreto">&laquo; <? echo $txMenuPrincipal; ?></a></td>
            </tr>
            <tr>
              <td class="td">&nbsp;</td>
            </tr>
          ...
          <td height="100%" valign="top" class="tdConteudo"> 
            ...
            <? } ?>
            <br> <div> 
              <table width="90%" align="center" cellpadding="5" class="loginTable">
                <tr> 
...
?>
                      <tr align="center" class="tdBiblioteca"> 
                        <td colspan="3" class="txtBold"><? echo $txContribuidorTDE; ?></td>
                      </tr>
                      <? } else {
...
?>
                      <tr class=<? echo $estiloTR; ?>> 
                        <td><? echo $pfNome; ?></td>
                        <td><? echo $tspfTipo; ?></td>
                        <td width="50" align="center" valign="middle"><a href="alterar_contribuidores.php?cod=Excluir&ApfCod=<? echo $MpfCod; ?>&VtsIdentificador=<? echo $VtsIdentificador; ?>&VpfCod=<? echo $VpfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}}
              ...
              <tr> 
                <td> <form name="form1" method="post" action="">
                  ...
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                    ...
                    <tr>
                      <td height="23" colspan="2"><input name="busca" type="text" class="input"  size="4" maxlength="3" value="<? echo $busca; ?>">
                          <input name="Submit" type="submit" class="botao" value="Localizar &raquo;">
                      </td>
                    </tr>
                    <? if ($busca!="" or $SpfCod!="") { ?>
                    <tr>
...
$qtd_pf=count($pfCods);
				...
				$pfNome=$SEL_pf3_RES["pfNome"];
				 ...
				 ?>
                          ...
                          <input name="tsIdentificador2" type="hidden" class="input" id="tsIdentificador25" value="<?echo $tsIdentificador;?>">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      ...
                      <tr> 
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr> 
                              ...
                              <td width="91%"><select name="tspfTipo" class="select" id="tspfTipo">
                                  <option value=""><? echo $txSelecionar; ?></option>
                                  <option value="Membro da Banca">Membro da Banca</option>
                      ...
                      <tr> 
                        <td align="right" valign="bottom"><input name="tsIdentificador" type="hidden" class="input" id="tsIdentificador" value="<?echo $tsIdentificador;?>"> 
                          ...
                          <input name="MpfCod" type="hidden" class="input" id="pfCod" value="<?echo $ApfCod;?>"> 
                          <input name="VpfCod" type="hidden" class="input" value="<?echo $VpfCod;?>"> 
