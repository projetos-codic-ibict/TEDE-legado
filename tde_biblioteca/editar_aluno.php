...
$SEL_pr1="SELECT prCod FROM TSPF WHERE pfCod=$pfCod and tspfTipo ='Autor' and tspfDisponivel!=9 and tspfDisponivel!=8";
$SEL_pr1_query=mysql_db_query($base,$SEL_pr1,$conexao);
$SEL_pr1_RES=mysql_fetch_array($SEL_pr1_query);
$VprCod=$SEL_pr1_RES["prCod"];
...
?>
                            ...
                            <input name="prCodAntigo" type="hidden" class="input" value="<? if ($prCodAntigo=="") { echo $VprCod; } else { echo $prCodAntigo; } ?>"></td>
                        </tr>
                        <tr class="txt"> 
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
