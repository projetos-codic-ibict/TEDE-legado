         ...
         <tr> 
		  ...
		  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" valign="middle" class="tdBiblioteca"> 
                        <td colspan="3" class="txtBold"> <? echo $txTDEIniciada; ?></td>
                      </tr>
                      <?
$estiloTR="tr";
...
$prNome=$SEL_pr_RES["prNome"];
				 ...
				 $SEL_tspf="SELECT * FROM TSPF WHERE prCod='$SprCod' and tspfTipo='Autor' and tsIdentificador!='0' and (tspfDisponivel='0' or tspfDisponivel='1')";
				...
				?><tr align="center" class="txtBold"> 
                      ...
                      <tr class="tdOperacoes"> 
                        ...
                        <td width="70" align="center"><? echo $txAlterarTDE; ?></td>
                      </tr>
                      <?
                $SEL_tspf="SELECT * FROM TSPF WHERE prCod='$SprCod' and tspfTipo='Autor' and tsIdentificador!='0' and (tspfDisponivel='0' or tspfDisponivel='1')";
           		$SEL_tspf_query=mysql_db_query($base,$SEL_tspf,$conexao);
					...
					?>
                      <tr align="left" valign="middle"> 
                        <td class=<? echo $estiloTR; ?>> 
                          <? if ($tspfDisponivel=="0") { echo $pfNome;  }

						if ($tspfDisponivel=="2") { echo $pfNome;  } if ($tspfDisponivel=="1" and $SEL_cn_RES=="") { echo $pfNome;  } 

						if ($tspfDisponivel!="0" and $tspfDisponivel!="2" and $SEL_cn_RES!="") {
                        echo $pfNome; } ?>
                        </td>
                        ...
                        <td width="60" align="center" class=<? echo $estiloTR; ?>><a href="alterar_tde.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" name="alterar" hspace="0" vspace="0" border="0" align="absmiddle" id="alterar"></a></td>
