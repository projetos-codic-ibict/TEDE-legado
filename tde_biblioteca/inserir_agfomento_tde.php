...
<table width="100%" height="80"  border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" -->
	  ...
	  require "../conexao/conexao.inc";
	  require "biblioteca/inserir_agfomento_tde.inc";
	  }
require "../conexao/conexao.inc";
?>
            <div> 
                ...
                <tr> 
                  <td align="center" valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="txt">
                      <tr align="center" bgcolor="<? echo $cor; ?>"> 
                        <td colspan="2" class="tdAluno"><span class="txtBold"><? echo $txAgenciaDeFomento; ?></span></td>
                      </tr>
					  <?
...
?>
                      <tr class="<? echo $estiloTR; ?>"> 
                        ...
                        <td width="38" align="center"><a href="inserir_agfomento_tde.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>&cod=Excluir&pjCod=<? echo $pjCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	} }
