...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | P&oacute;s-Gradua&ccedil;&atilde;o | Visualiza&ccedil;&atilde;o e Inser&ccedil;&atilde;o de Alunos</title>
<!-- InstanceEndEditable --> 
...
<table width="100%" height="80"  border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" --> 
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  ?>
              ...
              <tr> 
                <td height="12" class="subMenuOver" onClick="location='inserir_aluno.php'"><a href="inserir_aluno.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
	  ...
	  if ($Inserir!="") {
	  require "../conexao/conexao.inc";
	  require "biblioteca/inserir_aluno.inc";
	  }
require "../conexao/conexao.inc";
 if ($sucesso!="" or $erro!="") { ?>
            <div>
			<table width="90%" height="85" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                  <td height="83" align="center" valign="middle"> <? echo $erro;  echo $sucesso; ?></td>
              </tr>
            </table>
			</div><br /><? } ?>
			<div>
                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr> 
                          ...
                          <td width="84%"> <input name="pfNome" type="text" class="req" value="<?echo $pfNome;?>" size="50" maxlength="100"> 
                            <input name="pfCod" type="hidden" class="input" value="<?echo $pfCod;?>"> 
                          </td>
                        </tr>
                        <tr>
                          <td class="txtBold"><? echo $txCitacao; ?></td>
                          <td><input name="pfCitacao" type="text" id="pfCitacao" value="<?echo $pfCitacao;?>" size="50" maxlength="100" class="input"></td>
                        </tr>
                        <tr> 
                          <td class="txtBold"><? echo $txCitacaoABNT; ?></td>
                          <td><input name="pfCitacaoABNT" type="text" id="pfCitacaoABNT" value="<?echo $pfCitacaoABNT;?>" size="50" maxlength="100" class="input"></td>
                        </tr>
                        <tr> 
                          <td class="txtBold"><a href="<? echo $linkLattes; ?>" target="_blank"><? echo $txLattes; ?></a></td>
                        ...
                        <tr> 
                          ...
                          <td bgcolor="#FFFFFF"><? echo $txExemplo; ?>: a@a.br, 
                            b@seuprovedor.com.br<br> <input name="pfEmail" type="text" class="email" " value="<?echo $pfEmail;?>" size="40" maxlength="100"> 
                          </td>
                        </tr>
                        <tr> 
                          <td class="txtBold">&nbsp;</td>
                        ...
                        <tr> 
                          ...
                          <td><select name="prCod" id="prCod" class="select">
...
?>
                              <option value="<? echo $VprCod; ?>" <? if ($prCod==$VprCod) { echo "Selected"; }?>><? echo $prNome; ?></option>
                              <? $SEL_pr_RES=mysql_fetch_array($SEL_pr_query);
							  }
							  ?>
                            </select></td>
                        ...
                        <tr> 
                          <td colspan="2" class="txtBold"><select name="SpjCod" onChange="submit()">
                              <option value=""><? echo $txSelecionar; ?></option>
...
$SEL_pj_RES=mysql_fetch_array($SEL_pj_query);
				...
				$pjNome=$SEL_pj_RES["pjNome"];
				 ...
				 $SEL_pj_RES=mysql_fetch_array($SEL_pj_query); }
				 ?>
                              <option value="Nenhum" <? if ($SpjCod=="Nenhum") { echo "Selected"; }?>>Nenhum 
                              acima</option>
				...
				$pjURL=$SEL_pj1_RES["pjURL"];
                        ...
                        <tr> 
                          ...
                          <td> 
                            ...
                            <input name="ApjSigla" type="text" class="input" id="pjSigla2" value="<? echo $ApjSigla; ?>" size="25" maxlength="30"> 
                            <? } ?>
                          </td>
                        </tr>
                        <tr> 
