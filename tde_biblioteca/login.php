<? 
//echo $diretorio_layout;
if ($Submit!="") {
if ($enviar_senha!=1) {
require "biblioteca/valida.inc";
}else{
require "biblioteca/envia_conta_pos.inc";
}
}
?> 
...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" --> 
      <? if ($sucesso!="") { ?>
      <div><br>
        <table width="70%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
          <tr> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="92%" valign="top"><br> <table width="700" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td width="92%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td height="67" align="left" valign="top" class="txt"> <p class="loginTableTitle"><? echo $txBiblioteca; ?>: 
                          <span class="loginPos"> 
                          <? if ($alterar==1 or $enviar_senha==1) { if ($enviar_senha==1) { echo $txEnviarSenha; }else{ echo $txAlterarLogin; } }else{ echo $txLogin; }?>
                          </span></p>
                        <p class="txtBold"> 
                          <? if ($alterar==1 or $enviar_senha==1) { if ($enviar_senha==1) { echo $txEntreLoginParaES; }else{ echo $txLoginParaACBib; }}else{ echo $txLoginParaBiblioteca; }?>
                        </p>
                        <? echo $erro0; echo $erro; echo $erro1; echo $erro2; echo $erro3; echo $erro4;  echo $erro5;?> 
                      </td>
                    </tr>
                    <tr> 
                      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="txt">
                          <tr> 
                            <td><form action="" method="post" name="form1" onSubmit="return checkForm(this.name); return true;">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                                  <tr> 
                                    <td width="20" height="30" align="center" valign="middle"><img src="../tde_layout1/imagens/arrow.gif" width="7" height="7"></td>
                                    <td width="106" height="30" valign="middle"><b><? echo $txLogin; ?></b> 
                                      <? echo $txDaConta; ?></td>
                                    <td height="30"><input name="cnLogin" type="text" class="req" id="cnLogin" value="<?echo $cnLogin;?>" size="30" maxlength="100"></td>
                                    <td width="60" height="30">&nbsp;</td>
                                  </tr>
                                  <? if ($enviar_senha!=1) {?>
                                  <tr> 
                                    <td width="20" height="30" align="center" valign="middle"><img src="../tde_layout1/imagens/arrow.gif" width="7" height="7"></td>
                                    <td width="106" height="30" valign="middle"><strong><? echo $txSenha; ?></strong></td>
                                    <td height="30"><input name="cnSenha" type="password" class="req" size="15" maxlength="30"></td>
                                    <td width="60" height="30">&nbsp;</td>
                                  </tr>
                                  <? } ?>
                                  <tr> 
                                    <td height="30">&nbsp;</td>
                                    <td height="30"><a href="../tde_ajuda/ajuda.php"  class="linkpreto" target="_blank"><? echo $txAjuda; ?><img src="../tde_layout1/imagens/ajuda.gif" hspace="3" border="0" align="top"></a> 
                                      <input type="hidden" name="alterar" value="<? echo $alterar; ?>"> 
                                      <input type="hidden" name="enviar_senha" value="<? echo $enviar_senha; ?>"></td>
                                    <td height="30" align="right" valign="bottom"> 
                                      <? if ($enviar_senha==1) { ?>
                                      <a href="login.php" class="linkpreto"><? echo $txLoginParaBiblioteca; ?> 
                                      &raquo;</a> 
                                      <? } else{ ?>
                                      <a href="login.php?enviar_senha=1" class="linkpreto"><? echo $txEsqueceuSenha; ?></a> 
                                      <? } ?>
                                      <br> 
                                      <? if ($alterar==1) { ?>
                                      <a href="login.php" class="linkpreto"><? echo $txLoginParaBiblioteca; ?> 
                                      &raquo;</a> 
                                      <? } else{ ?>
                                      <a href="login.php?alterar=1" class="linkpreto"><? echo $txAlterarSeuCadastro; ?> 
                                      &raquo;</a> 
                                      <? } ?>
                                    </td>
                                  ...
                                  <tr> 
                                    ...
                                    <td height="30" align="right" valign="bottom"><input name="Submit" type="submit" class="botao" value="<? if ($enviar_senha==1) { echo $txEnviar; }else{ echo $txEntrar; } ?> &raquo;"></td>
                                    <td width="60" height="30" align="left" valign="bottom">&nbsp;</td>
                                  </tr>
                                </table>
                              </form></td>
                            <td width="280" align="left" valign="middle" class="txt"><? echo $txEntreLogin; ?>. 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td height="26" align="right" valign="bottom" class="txt"><font color="#CC0000"><strong><? echo $txCasoNaoPossueConta; ?>.</strong></font></td>
                    </tr>
                  </table></tr>
            </table>
            <br> </tr>
