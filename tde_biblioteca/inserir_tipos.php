			  ...
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td align="center" valign="middle"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                    <tr align="center">
                      <td colspan="2" class="tdAluno"><strong><? echo $txTipo; ?></strong></td>
                    </tr>
                    <tr align="center"> 
                      <td>&nbsp;</td>
...
echo "Nenhum Tipo inserido para essa tese.";
                      ...
                      <td width="100" align="center" valign="middle" class=<? echo $estiloTR; ?>><? if ($tpTipo!="Electronic Thesis and Dissertation") { ?><a href="inserir_tipos.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>&cod=Excluir&tpCod=<? echo $tpCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } ?></td>
                    </tr>
                    <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}
