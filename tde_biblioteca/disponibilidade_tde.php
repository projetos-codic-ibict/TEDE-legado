        ...
        <tr> 
		  ...
		  if ($sucesso!="" or $erro!="") { ?>
            ...
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="3" class="loginTable">
              <tr>
                <td width="4%" class="txt"><input name="drDireito" type="radio" class="radio" value="Liberar o conte&uacute;do dos arquivos para acesso p&uacute;blico" <? if ($drDireito=="Liberar o conteúdo dos arquivos para acesso público") { echo "checked";}?>>
                </td>
              ...
              <tr>
                <td class="txt"><strong>
                  <input name="drDireito" type="radio" class="radio" value="Liberar o conte&uacute;do dos arquivos somente para a comunidade da Universidade" <? if ($drDireito=="Liberar o conteúdo dos arquivos somente para a comunidade da Universidade") { echo "checked";}?>>
                </strong></td>
                <td class="txtBold">2.</td>
                    <td class="txt"><? echo $txLiberarCAARestrito; ?></td>
              </tr>
              <tr>
                <td class="txt"><input name="drDireito" type="radio" class="radio" value="Reter o conte&uacute;do dos arquivos por motivos de patente, publica&ccedil;&atilde;o e/ou direitos autorais" <? if ($drDireito=="Reter o conteúdo dos arquivos por motivos de patente, publicação e/ou direitos autorais") { echo "checked";}?>>
                </td>
                <td class="txtBold">3.</td>
                    <td class="txt"><? echo $txReterACARetido; ?></td>
              </tr>
              <tr>
                <td class="txt"><input name="drDireito" type="radio" class="radio" value="Liberar o conte&uacute;do de alguns arquivos para acesso p&uacute;blico, restringir o conte&uacute;do de outros arquivos para acesso somente da comunidade da Universidade e/ou reter o conte&uacute;do de alguns arquivos por motivos de patente, publica&ccedil;&atilde;o e/ou direitos autorais" <? if ($drDireito=="Liberar o conteúdo de alguns arquivos para acesso público, restringir o conteúdo de outros arquivos para acesso somente da comunidade da Universidade e/ou reter o conteúdo de alguns arquivos por motivos de patente, publicação e/ou direitos autorais") { echo "checked";}?>>
                </td>
                <td class="txtBold">4.</td>
                    <td class="txt"><? echo $txLCAAPubResRet; ?>
                      <? if ($drDireito==""){ ?>
                      <input name="cod" type="hidden" id="cod" value="Inserir"><? } ?></td>
              </tr>
              <tr>
