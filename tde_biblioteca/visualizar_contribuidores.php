          ...
          <td height="100%" valign="top" class="tdConteudo">
            ...
            <div><table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr> 
                ...
                <td width="90%"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdBiblioteca"> 
                        <td height="13" colspan="4" class="txtBold"><? echo $txContribuidor; ?></td>
                      </tr>
                      <?
require "../conexao/conexao.inc";
$estiloTR="tr";
...
$SEL_pf="SELECT * FROM PessoaFisica WHERE pfContribuidor='1' ORDER BY pfNome ";
...
?>
                      ...
                      <? } else { ?>
                      <tr class="tdOperacoes"> 
                        <td colspan="2"><? echo $txNome; ?></td>
                        <td width="50" align="center"><? echo $txAlterar; ?></td>
...
?>
                      <tr> 
                        ...
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="editar_contribuidores.php?pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="excluir_contribuidores.php?pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <? if ($EVpfCod=="$pfCod") {
					     if ($pfLattes!="") {?>
                      <tr> 
                        <td width="90" class=<? echo $estiloTR; ?>><span class="txtBold"><? echo $txLattes; ?></span></td>
                        <td class=<? echo $estiloTR; ?>><? echo $pfLattes; ?></td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                      </tr>
					  <?  } if ($pfCitacao!="") {?>
                      <tr>
                        <td width="90" class=<? echo $estiloTR; ?>><span class="txtBold"><? echo $txCitacao; ?></span></td>
                        <td class=<? echo $estiloTR; ?>><?echo $pfCitacao;?></td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                      </tr>
					  <?  } if ($pfCPF!="") {?>
                      <tr>
                        <td width="90" class=<? echo $estiloTR; ?>><? echo $txCPF; ?></td>
					  ...
					  <?  } if ($pfEmail!="") {?>
                      <tr>
                        <td width="90" class=<? echo $estiloTR; ?>><span class="txtBold"><? echo $txEMail; ?></span></td>
                        <td class=<? echo $estiloTR; ?>><? echo $pfEmail; ?></td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                        <td width="50" class=<? echo $estiloTR; ?>>&nbsp;</td>
                      </tr><? } if ($pjNome!="") {?>
                      <tr>
                        <td width="90" class=<? echo $estiloTR; ?>> <span class="txtBold"><? echo $txAfiliacao; ?></span></td>
                        <td class=<? echo $estiloTR; ?>><?echo $pjNome;?>
                      ...
                      <tr>
                        <td width="90" class=<? echo $estiloTR; ?>>&nbsp;</td>
