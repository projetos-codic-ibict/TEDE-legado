...
?>
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  ?>
              ...
              <tr> 
                <td height="12" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='inserir_contribuidores.php'"><a href="inserir_contribuidores.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOver" onClick="location='visualizar_contribuidores.php?v=Editar'"><a href="visualizar_contribuidores.php?v=Editar" class="linkpreto">&raquo; 
	  ...
	  if ($Editar!="") {
	  require "../conexao/conexao.inc";
	  require "biblioteca/manutencao_contribuidores.php";
	  }
require "../conexao/conexao.inc";
if ($SpjCod=="") {
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr align="center" valign="middle" class="tdBiblioteca"> 
                          <td colspan="4" class="txtBold"><? echo $txContribuidor; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td width="17%" class="txtBold"><? echo $txNome; ?></td>
                          <td colspan="3"> <input name="pfNome" type="text" class="req" id="pfNome2" value="<?echo $pfNome;?>" size="32" maxlength="100"> 
                            <input name="pfCod" type="hidden" class="input" value="<?echo $pfCod;?>"> 
                          </td>
                        </tr>
                        <tr class="txt"> 
                          <td class="txtBold"><? echo $txCitacao; ?></td>
                          <td colspan="3"><input name="pfCitacao" type="text" class="input"  value="<?echo $pfCitacao;?>" size="32" maxlength="150"></td>
                        </tr>
                        <tr class="txt"> 
                          <td class="txtBold"><a href="<? echo $linkLattes; ?>" target="_blank"><? echo $txLattes; ?></a> 
                          </td>
                          <td colspan="3"> <input name="pfLattes" type="text" class="input" id="pfLattes" value="<?echo $pfLattes;?>" size="32" maxlength="150"> 
                          </td>
                        </tr>
                        <tr class="txt"> 
                          ...
                          <td width="5%"><input name="pfEstrangeiro" type="checkbox" id="pfEstrangeiro" value="Sim" <? if ($pfCPF=="") {?>checked<? } ?>  class="radio" onChange="optional(this.form.name,this,this.form.pfCPF);" onBlur="optional(this.form.name,this,this.form.pfCPF);" onClick="optional(this.form.name,this,this.form.pfCPF);"></td>
                          <td width="49%"><? echo $txEstrangeiroSemCPF; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td bgcolor="#FFFFFF" class="txtBold"><? echo $txEMail; ?></td>
                          <td colspan="3" bgcolor="#FFFFFF"><? echo $txExemplo; ?>: 
                            a@a.br, b@seuprovedor.com.br<br> <input name="pfEmail" type="text" class="input" id="pfEmail" value="<?echo $pfEmail;?>" size="32" maxlength="100"></td>
                        </tr>
                        <tr class="txt"> 
                          <td class="txtBold">&nbsp;</td>
                          <td colspan="3"> 
                            <? $SEL_pr="SELECT prCod FROM Programa WHERE bdCod=$SbdCod";
$SEL_pr_query=mysql_db_query($base,$SEL_pr,$conexao);
$SEL_pr_RES=mysql_fetch_array($SEL_pr_query);
				
				$SprCod=$SEL_pr_RES["prCod"];
											?>
                            <input name="prCod" type="hidden" class="input" value="<?echo $SprCod;?>"> 
                          </td>
                        </tr>
                        <tr align="center" valign="middle" class="tdBiblioteca"> 
                        ...
                        <tr class="txt"> 
                          <td colspan="4" class="txtBold"><select name="SpjCod" onChange="submit()">
...
$SEL_pj_RES=mysql_fetch_array($SEL_pj_query);
				...
				$pjNome=$SEL_pj_RES["pjNome"];
				 ...
				 $SEL_pj_RES=mysql_fetch_array($SEL_pj_query); }
				 ?>
                              <option value="Nenhum"><? echo $txNenhumAcima; ?></option>
                              <option value="SemAfiliacao" <? if ($SpjCod=="SemAfiliacao") { echo "Selected"; }?> class="txtBold">Sem 
                              afiliação</option>
                            </select></td>
                        </tr>
                        <?
				if ($SpjCod!="SemAfiliacao") {
				if (($SpjCod!="" and $SpjCod!="SemAfiliacao") or $EpjCod!="") { 
				if ($SpjCod!="Nenhum") {
				...
				$pjURL=$SEL_pj1_RES["pjURL"];
                        ...
                        <tr class="txt"> 
                          ...
                          <td colspan="3"> 
                            ...
                            <? } else { ?>
                            <input name="pjNome" type="text" class="req" id="pjNome2" size="32" maxlength="100"> 
                            <? } ?>
                        ...
                        <tr class="txt"> 
                          ...
                          <td colspan="3"> 
                            ...
                            <input name="pjSigla" type="text" class="input" id="pjSigla2" size="32" maxlength="30"> 
                            <? } ?>
                          </td>
                        </tr>
                        <tr class="txt"> 
						  ...
						  echo  $pjPais; } else { ?>
                            <select name="pjPais" class="select">
                              <? $SEL_ps="SELECT * FROM Pais ORDER BY psNome";
                            $SEL_ps_query=mysql_db_query($base,$SEL_ps,$conexao);
                            $SEL_ps_RES=mysql_fetch_array($SEL_ps_query);
							...
							?>
                              <option value="<? echo $psSigla; ?>" <? if ($psSigla=="BR") {?>selected<? } ?>><? echo $psNome; ?></option>
                              <? $SEL_ps_RES=mysql_fetch_array($SEL_ps_query);
						   }
						   ?>
                            </select> 
                        ...
                        <tr class="txt"> 
                          ...
                          <td colspan="3"> 
                            ...
                            <select name="pjUF" class="input">
                              ...
                              <? } $SEL_uf="SELECT * FROM UnidadeFederativa ORDER BY ufNome";
							...
							?>
                              <option value="<? echo $ufSigla; ?>" <? if ($pjUF==$ufSigla) { echo "Selected"; } ?>><? echo $ufNome; ?></option>
                              <? $SEL_uf_RES=mysql_fetch_array($SEL_uf_query);
						   }
						   ?>
                        ...
                        <tr class="txt"> 
                          ...
                          <td colspan="3"> 
                            ...
                            <input name="pjURL" type="text" class="input" id="pjURL2" size="32" maxlength="150"> 
                            <? } ?>
                          </td>
                        </tr>
                        <? } }?>
                        <tr class="txt"> 
                          <td><input name="cod" type="hidden" class="input" value="Editar"></td>
                          <td colspan="3" align="right" valign="bottom"> <input name="Editar" type="submit" class="botao" id="Editar2" value="<? echo $txAlterar; ?> &raquo;"></td>
                        </tr>
                      </table></td>
                </tr>
              </table></div><br>
