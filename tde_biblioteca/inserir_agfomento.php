      ...
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
		  ...
		  ?>
              ...
              <tr> 
                <td class="subMenuOver" onMouseOver="this.className='subMenuOver'" onClick="location='inserir_agfomento.php'"><a href="inserir_agfomento.php" class="linkpreto"> 
                  &raquo; <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onClick="location='visualizar_agfomento.php?v=Editar'" onMouseOut="this.className='subMenuOut'"><a href="visualizar_agfomento.php?v=Editar" class="linkpreto">&raquo; 
                ...
                <tr> 
                  <td height="80%"><table width="100%" border="0" align="left" cellpadding="5" cellspacing="0" class="txt">
                      <tr class="tdBiblioteca"> 
                        <td colspan="2" align="center" valign="middle" class="txtBold"><? echo $txAgenciaFomento; ?></td>
                      </tr>
                      <tr class="txt"> 
                        <td width="16%" class="txtBold"><? echo $txNome; ?></td>
                        <td width="84%"> <input name="pjNome" type="text" class="req" id="pjNome2" value="<? echo $pjNome; ?>" size="32" maxlength="100"> 
                        </td>
                      </tr>
                      <tr class="txt"> 
                        <td height="20" class="txtBold"><? echo $txSigla; ?></td>
                        <td> <input name="pjSigla" type="text" class="input" id="pjSigla2" value="<? echo $pjSigla; ?>" size="32" maxlength="30"> 
                        </td>
                      </tr>
                      <tr class="txt"> 
                      ...
                      <tr class="txt"> 
                        ...
                        <td> <input name="pjURL" type="text" class="input" id="pjURL2" value="<? echo $pjURL; ?>" size="32" maxlength="150"> 
                        </td>
                      </tr>
                      <tr class="txt"> 
