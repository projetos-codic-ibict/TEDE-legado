...
$estiloTR="trResposta";
		   ...
		   echo $idIdioma; ?>
                        ...
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><? if ($asEsquema!="Tabela CNPQ") {?><a href="editar_assunto_tde.php?asCod=<? echo $asCod; ?>&tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } ?></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><? if ($asEsquema!="Tabela CNPQ") {?><a href="excluir_assunto_tde.php?cod=Excluir&asCod=<? echo $asCod; ?>&tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a><? } ?></td>
                      </tr>
                      <?
		$sel2RESP=mysql_fetch_array($sel2_query);
	}}
