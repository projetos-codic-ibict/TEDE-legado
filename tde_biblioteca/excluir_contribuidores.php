...
$pfEmail=$SEL_pf_RES["pfEmail"];
 ...
 if ($sucesso!="" or $erro!="") { ?>
			  ...
			  <table width="90%" height="68" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td height="66" align="center" valign="middle"> <? echo $erro;  echo $sucesso; ?>                    
				    <p><br />
				    </p></td>
                </tr>
              </table><br></div><? } ?>
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr align="center" valign="middle" class="tdBiblioteca"> 
                          <td colspan="2" class="txtBold"> <? echo $txContribuidor; ?> </td>
                        </tr>
                        <tr class="txt"> 
                          <td width="18%" class="txtBold"><? echo $txNome; ?></td>
                          <td width="82%"> <?echo $pfNome;?> <input name="pfCod" type="hidden" class="input" value="<?echo $pfCod;?>"> 
                          </td>
                        </tr>
                        <tr class="txt"> 
...
$SEL_pj1_RES=mysql_fetch_array($SEL_pj1_query);
				...
				?>
                        ...
                        <tr class="txt"> 
                          <td height="26" class="txtBold"><? echo $txUF; ?></td>
                          <td> 
                            <?  echo  $pjUF;  ?>
                          </td>
                        </tr>
