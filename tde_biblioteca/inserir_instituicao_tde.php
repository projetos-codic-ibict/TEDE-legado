...
<?	         
$sel2="select inCod from Teses where tsIdentificador='$tsIdentificador'";
				...
				$inURL=$SEL_in1_RES["inURL"];
                      ...
                      <tr class="tdAlternado"> 
						  ...
						  echo $imputCNPJ;
                            ...
                            <input name="tsIdentificador" type="hidden" class="input" id="cod2" value="<? echo $tsIdentificador; ?>">
                            <input name="pfCod" type="hidden" class="input" id="cod3" value="<? echo $pfCod; ?>"> 
                          </td>
                      </tr>
                      <tr class="tdAlternado"> 
