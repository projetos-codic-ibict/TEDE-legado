         ...
         <tr> 
		  ...
		  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" valign="middle" class="tdBiblioteca"> 
                        <td colspan="3" class="txtBold"> <? echo $txTDE; ?></td>
                      </tr>
                      <?
...
$prNome=$SEL_pr_RES["prNome"];
				$SEL_tspf="SELECT * FROM TSPF WHERE prCod='$SprCod' and tspfTipo='Autor' and tsIdentificador!='0' and (tspfDisponivel='0' or tspfDisponivel='1' or tspfDisponivel='2')";
				...
				<tr align="center" class="txtBold"> 
                        <td height="20" colspan="5"><? echo $prNome; ?></td>
                      </tr>
                      ...
                      <tr class="tdOperacoes"> 
                        <td><? echo $txAutor; ?></td>
                        <td width="100" align="left"><? echo $txAlterarTDE; ?></td>
					...
					?>
                      <tr align="left" valign="middle"> 
                        ...
                        <td align="left" class=<? echo $estiloTR; ?>> 
                          ...
                          <? 
					  if ($tspfDisponivel=="0") { ?>
					 <a href="alterar_tde.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" name="alterar" hspace="0" vspace="0" border="0" align="absmiddle" id="alterar"></a> <?
					  } 
					  if ($tspfDisponivel=="1") { 
					  if ($SEL_cn_RES=="") {
					  ...
					  ?>
                        ...
                        <td width="60" align="center" class=<? echo $estiloTR; ?>><a href="alterar_tde_inicial.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"> 
                          </a> <a href="excluir_tde.php?tsIdentificador=<? echo $tsIdentificador; ?>&pfCod=<? echo $pfCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" name="excluir" hspace="0" vspace="0" border="0" align="absmiddle" id="excluir"></a> 
                        </td>
