  ...
  <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	<tr> 
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td height="19" class="td"> <p><span class="txtBold"> 
                    <?
		  ...
		  ?>
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='visualizar_afiliacao.php?v=Editar'"><a href="visualizar_afiliacao.php?v=Editar" class="linkpreto">&raquo;&nbsp;<? echo $txAlterar; ?>/<? echo $txExcluir; ?></a></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
              </tr>
  ...
  <tr> 
	...
	<td width="90%"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" valign="middle" class="tdBiblioteca"> 
                        <td height="13" colspan="4"><b><? echo $txAfiliacao; ?></b></td>
                      </tr>
                      <?
require "../conexao/conexao.inc";
$estiloTR="tr";
...
$estiloTR="trResposta";
	...
	?>
                      <tr> 
                        ...
                        <td width="50" align="center" valign="top" class=<? echo $estiloTR; ?>><a href="editar_pessoajuridica.php?pjCod=<? echo $pjCod; ?>&pjTipo=Afiliacao&vTipo=<? echo $vTipo; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center" valign="top" class=<? echo $estiloTR; ?>><a href="excluir_pessoajuridica.php?pjCod=<? echo $pjCod; ?>&pjTipo=Afiliacao&vTipo=<? echo $vTipo; ?>" class="linkpreto"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <? if ($EVpjCod==$pjCod) { ?>
                      <tr> 
                        <td width="36" valign="top" class=<? echo $estiloTR; ?>><strong><? echo $txSigla; ?></strong></td>
                        <td width="334" valign="top" class=<? echo $estiloTR; ?>><?echo $pjSigla;?> 
                        </td>
                        <td width="50" rowspan="5" align="center" valign="top" class=<? echo $estiloTR; ?>>&nbsp;</td>
                        <td width="50" rowspan="5" align="center" valign="top" class=<? echo $estiloTR; ?>>&nbsp;</td>
                      </tr>
                      <tr> 
                        <td valign="top" class=<? echo $estiloTR; ?> ><strong><? echo $txPais; ?></strong></td>
                        <td valign="top" class=<? echo $estiloTR; ?>><?
                      ...
                      <tr> 
                        ...
                        <td valign="top" class=<? echo $estiloTR; ?>><? echo $pjUF;?></td>
                      </tr>
                      <tr> 
                        <td valign="top" class=<? echo $estiloTR; ?>><strong><? echo $txCNPJ; ?></strong></td>
                        <td valign="top" class=<? echo $estiloTR; ?>><?echo $pjCNPJ;?></td>
                      </tr>
                      <tr> 
                        <td valign="top" class=<? echo $estiloTR; ?>><strong><? echo $txURL; ?></strong></td>
                        <td valign="top" class=<? echo $estiloTR; ?>><?echo $pjURL;?></td>
                      </tr>
                      <? }
