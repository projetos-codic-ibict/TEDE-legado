    ...
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" --> 
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  echo $bdNome;
		  ?>
             </span> <span class="txtBold">      </span><br> </td>
              </tr>
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo "$VpjTipo"; ?></span></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='<? echo $IpjLink; ?>'"><a href="<? echo $IpjLink; ?>" class="linkpreto">&laquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOver" onClick="location='<? echo $VpjLink; ?>'"><a href="<? echo $VpjLink; ?>" class="linkpreto">&laquo; 
                ...
                <tr> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr class="tdBiblioteca"> 
                        ...
                        <td colspan="2" align="center" valign="middle" class="txtBold"><? echo "$VpjTipo"; ?></td>
...
$SEL_pj1_RES=mysql_fetch_array($SEL_pj1_query);
                ...
                <tr> 
                  ...
                  <td align="right" valign="bottom"><input name="vTipo" type="hidden" class="input" id="pjCod2" value="<? echo $vTipo;?>"> 

                    <input name="pjCod" type="hidden" class="input" id="pjCod" value="<? echo $pjCod;?>">
