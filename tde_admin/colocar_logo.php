...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" -->
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	  <? if ($trocar!="" or $trocar2!="" or $trocar3!="") {
require "biblioteca/manutencao_logo.inc";
}
	  ?>
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txLogomarca; ?></span></td>
              </tr>
			  <tr> 
                <td class="subMenuOver" onClick="location='colocar_logo.php'"><a href="colocar_logo.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
             <tr> 
                <td class="td">&nbsp;</td>
    ...
    echo "<META HTTP-EQUIV='REFRESH' CONTENT=\"0; URL='colocar_logo.php?i=1&sucesso=$sucesso'\">";
            ...
            <div><form action="" method="post" enctype="multipart/form-data" name="form" onSubmit="return checkForm(this.name); return true;">
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr align="center"> 
                  <td colspan="2" class="bttmBar"></td>
                </tr>
                <tr align="center" class="tdAdmin"> 
                  <td colspan="2" class="txtBold"><? echo $txLogomarca; ?></td>
                </tr>
                <tr> 
                  <td width="109" align="center" class="txtBold"> <? echo $txLogoAtual; ?> &raquo;</td>
                  <td width="430" align="left" valign="middle"><a href="<? echo $link; ?>" target="_blank" class="menu"><img src="<? echo $diretorio_layout; ?>imagens/logo_inst.jpg" alt="<? echo $texto; ?>" name="logoInst" width="139" height="60" hspace="0" vspace="0" border="0" id="logoInst"></a> 
                  <br /> </td>
                </tr>
                <tr> 
                  <td height="14" colspan="2">
                      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        <? if ($sucesso=="") { ?>
                        <tr> 
                          <td height="24" colspan="2" class="txtBold"> <span class="Obs"><? echo $txAIDT139L60A; ?>.</span></td>
                        </tr>
                        <tr> 
                          <td height="34" valign="bottom"> <? echo $txSelecionarArquivo; ?></td>
                          <td height="34" valign="bottom"><input name="arquivo" type="file" class="input" id="arquivo4">
                          <input name="trocar" type="hidden" value="Sim"></td>
                        </tr>
                        <tr>
                          <td width="11%" valign="bottom"><? echo $txLink; ?></td>
                          <td width="89%" valign="bottom"><input name="Alink" type="text"  class="input" id="Alink" value="<? echo $link; ?>" size="40"></td>
                        </tr>
                        <tr>
                          <td valign="bottom"><? echo $txTexto; ?></td>
                          <td valign="bottom"><input name="Atexto" type="text"  class="input" id="Atexto" value="<? echo $texto; ?>" size="60"></td>
                        </tr>
                        <tr> 
            ...
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr align="center" class="tdAdmin">
                  <td colspan="2" class="txtBold"> <? echo $txLogoInferior; ?> 
                    1</td>
              </tr>
              <tr>
                  <td width="109" align="center" class="txtBold"> <? echo $txLogo1Atual; ?> 
                    &raquo;</td>
                <td width="430" align="left" valign="middle"><a href="<? echo $link2; ?>" target="_blank" class="menu"><img src="<? echo $diretorio_layout; ?>imagens/logo_tede1.gif" / alt="<? echo $texto2; ?>" height="33" border="0"></a> <br />
                </td>
              </tr>
              <tr>
                <td height="14" colspan="2">
                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      <? if ($sucesso=="") { ?>
                      <tr>
                        <td height="24" colspan="2" class="txtBold"> <span class="Obs"><? echo $txAIDT30A; ?>.</span></td>
                      </tr>
                      <tr>
                        <td height="34" valign="bottom"> <? echo $txSelecionarArquivo; ?></td>
                        <td height="34" valign="bottom"><input name="arquivo2" type="file" class="input" id="arquivo22">
                        <input name="trocar2" type="hidden" value="Sim"></td>
                      </tr>
                      <tr>
                        <td width="13%" valign="bottom"><? echo $txLink; ?></td>
                        <td width="87%" valign="bottom"><input name="Alink2" type="text" class="input" id="Alink2" value="<? echo $link2; ?>" size="40"></td>
                      </tr>
                      <tr>
                        <td valign="bottom"><? echo $txTexto; ?></td>
                        <td valign="bottom"><input name="Atexto2" type="text" class="input" id="Atexto2" value="<? echo $texto2; ?>" size="60"></td>
                      </tr>
                      <tr>
            ...
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr>
                  <td width="109" align="center" class="txtBold"> <? echo $txLogo2Atual; ?> 
                    &raquo;</td>
                <td width="430" align="left" valign="middle"><a href="<? echo $link3; ?>" target="_blank" class="menu"><img src="<? echo $diretorio_layout; ?>imagens/logo_tede2.gif" / alt="<? echo $texto3; ?>" height="33" border="0"></a> <br />
                </td>
              </tr>
              <tr>
                <td height="14" colspan="2">
                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      ...
                      <tr>
                        <td height="34" valign="bottom"> <? echo $txSelecionarArquivo; ?></td>
                        <td height="34" valign="bottom"><input name="arquivo3" type="file" class="input" id="arquivo2">
                          <input name="trocar3" type="hidden" value="Sim"></td>
                      </tr>
                      <tr>
                        <td valign="bottom"><? echo $txLink; ?></td>
                        <td valign="bottom"><input name="Alink3" type="text" class="input" id="Alink3" value="<? echo $link3; ?>" size="40"></td>
                      </tr>
                      <tr>
                        <td width="11%" valign="bottom"><? echo $txTexto; ?></td>
                        <td width="89%" valign="bottom"><input name="Atexto3" type="text" id="Atexto3" value="<? echo $texto3; ?>" size="60" class="input"></td>
                      </tr>
                      <tr>
                        <td colspan="2" align="right" valign="bottom">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="2" align="right" valign="bottom"><input name="Submit3" type="submit" class="botao" value="<? echo $txAlterar; ?> &raquo;">
                        </td>
                      </tr>
                      <? } ?>
                    </table>
