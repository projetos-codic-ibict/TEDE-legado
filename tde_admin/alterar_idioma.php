...
<? if ($Alterar!="") {
require "biblioteca/alterar_idioma.inc";
exit;
}
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txIdioma;?></span></td>
              </tr>
			   <tr> 
                <td class="subMenuOver" onClick="location='alterar_expiracao.php'"><a href="alterar_idioma.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar;?></a></td>
              </tr>
             <tr> 
                <td class="td">&nbsp;</td>
           ...
           <div>
		      <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr align="left" class="tdAdmin"> 
                  <td width="100%" align="center" class="txtBold"><? echo $txIdiomaDoSistema;?></td>
                </tr>
                <tr> 
                  <td height="14"><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;">
                      <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                        <? if ($sucesso=="") { ?>
                        <tr> 
                          <td height="34" align="left" valign="bottom" class="txtBold"><? echo $txAlterarIdioma;?></td>
                        </tr>
                        <tr> 
                          <td height="34" align="left" valign="bottom"> 
                            <?
$i=0;
if ($dir=opendir("../tde_i18n/tde_admin")){
while(($arquivos=readdir($dir)) !== false){

if ($arquivos <> "." && $arquivos <> ".." )
{
$idiomas_split=split("mensagens_",$arquivos);
$idiomas_split2=split(".txt",$idiomas_split[1]);
$idiomas[$i]=$idiomas_split2[0];
$i++;
}
}
}
...
for ($v=0; $qtd>$v; $v++) {
?>
                              <option value="<? echo $idiomas[$v];?>" <? if ($idioma_sistema==$idiomas[$v]) { echo "selected"; } ?>><? echo $idiomas[$v];?></option>
                              <? } ?>
                            </select> </td>
                        </tr>
                        <tr> 
                          <td align="right" valign="bottom"><input name="Alterar" type="submit" class="botao" id="Alterar" value="<? echo $txAlterar;?> &raquo;"> 
                          </td>
                        </tr>
                        <? } ?>
                      </table>
					...
					require "../bibliotecas/idioma_sistema.bib";
					?>
                    <strong><? echo $txIdiomaAtual;?>:</strong> <span class="sucesso"><? echo $idioma_sistema;?></span><br><br>
                    <?
					}?>
                  </td>
                </tr>
