...
<title>| Sistema de Sumiss&atilde;o de Teses e Disserta&ccedil;&otilde;es Eletr&ocirc;nicas | ADMINISTRA&Ccedil;&Atilde;O | Conta do Catalogador</title>
<!-- InstanceEndEditable --> 
...
?>
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='conta_catalogador.php'"><a href="conta_catalogador.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td height="13" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_contas_cat.php?v=Editar'"><a href="visualizar_contas_cat.php?v=Editar" class="linkpreto">&raquo; 
                ...
                <tr> 
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr> 
                          ...
                          <td width="84%"><select name="bdCod" class="select" id="bdCod">
                              <? if ($bdCod!="" and $sucesso=="") { 
				  $VbdCod_split=split(",",$bdCod);
				  
				  $VbdCod=$bdCod_split[0];
				  $VbdNome=$bdCod_split[1];
				  ?>
                              <option value="<? echo $VbdCod.','.$VbdNome;?>"><? echo $VbdNome; ?></option>
                              <? } ?>
                              <option value="">Seleciona</option>
                              <? $SEL_bd="SELECT * FROM BibliotecaDepositaria WHERE bdStatus!='INATIVA' ORDER BY bdNome";
...
$SEL_bd_RES=mysql_fetch_array($SEL_bd_query);
				...
				$bdNome=$SEL_bd_RES["bdNome"];
											...
											?>
                              <option value="<? echo $bdCod.','.$bdNome;?>" <? if ($bdCod==$bdCodL) { echo "Selected"; }?>><? echo $bdNome;?></option>
                              <? $SEL_bd_RES=mysql_fetch_array($SEL_bd_query); }
				 ?>
                            </select></td>
                        </tr>
                        <tr> 
                          ...
                          <td><input name="cnNome" type="text" class="req" id="cnNome2" value="<? echo $cnNome;?>" size="60" maxlength="100"></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                          ...
                          <td><input name="cnSenha2" type="password" class="req" id="cnSenha" size="15" maxlength="30"></td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                          ...
                          <td><input name="cnTipo" type="radio" value="Catalogador" checked> 
                            <? echo $txComum; ?> <input type="radio" name="cnTipo" value="MasterCataloga"> 
                            <? echo $txMaster; ?></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        ...
                        <tr class="tdAdmin"> 
                          ...
                          <td><input type="radio" name="cnBloqueado" value="1" <? if ($cnBloqueado=="1") {?> checked <? } ?>> 
                            <? echo $txSim; ?> <input name="cnBloqueado" type="radio" value="0" <? if ($cnBloqueado=="0" or $cnBloqueado=="") {?> checked <? } ?>> 
                            <? echo $txNao; ?></td>
                        </tr>
                        <tr align="right"> 
                          <td> 
                            <input name="cod" type="hidden" value="Inserir"></td>
                          <td><input name="Inserir" type="submit" class="botao" id="Inserir2" value="<? echo $txInserir; ?> &raquo;"></td>
                        </tr>
                      </table></td>
                </tr>
              </table></div>
