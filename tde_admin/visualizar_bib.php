...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | ADMINISTRA&Ccedil;&Atilde;O | Biblioteca Deposit&aacute;ria</title>
		  ...
		  <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
            ...
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              ...
              <tr> 
                ...
                <td width="90%"><table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
				<tr align="center">
				<td colspan="4" class="tdAdmin"><span class="txtBold"><? echo $txBibliotecaDepositaria; ?></span></td>
				</tr>
                    <? 
...
$SEL_bd="SELECT * FROM BibliotecaDepositaria ORDER BY bdNome";
...
?>
                    <tr class="tdOperacoes"> 
                      <td colspan="4"><span class="txtBold"><? echo $txNenhumRegistroC; ?>.</span></td>
                    </tr>
                    <? } else { 
					$SEL_bd_st="SELECT * FROM BibliotecaDepositaria WHERE bdStatus='INATIVA'";
$SEL_bd_st_query=mysql_db_query($base,$SEL_bd_st,$conexao);
$SEL_bd_st_RES=mysql_fetch_array($SEL_bd_st_query);
					?>
                    <tr class="txtBold"> 
                      <td align="left" valign="middle"><? echo $txNome; ?></td>
                      <td align="left" valign="middle"><? echo $txSigla; ?></td>
					  <? if ($SEL_bd_st_RES!="") { ?>
                      <td width="50" align="center" valign="middle"><? echo $txStatus; ?></td>
                      <? } ?>
...
$cor=$estilo;
				...
				$bdStatus=strtolower($SEL_bd_RES["bdStatus"]);
				$bdStatus=ucwords($bdStatus);
               ...
               if ($bdCod==$VbdCod) {
				...
				?>
                    <tr> 
                      <td align="left" valign="middle" class="<? echo $cor;?>"><? echo $bdNome;?></td>
                      <td align="left" valign="middle" class="<? echo $cor;?>"><? echo $bdSigla;?></td>
					  
                     <? if ($SEL_bd_st_RES!="") { ?> <td width="50" align="center" valign="middle" class="<? echo $cor;?>"><? if ($bdStatus=="Inativa") { echo "<img src=\"../tde_layout1/imagens/inativo.gif\" hspace='0' vspace='0' border='0' align=\"absmiddle\"/>";  } ?></td>
                     <? } ?>
                     
                      <td width="50" align="center" valign="middle" class="<? echo $cor;?>"><a href="editar_bib.php?bdCod=<? echo $bdCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
