...
if ($trocar=="Sim") {
require "biblioteca/alterar_bloqueio_arquivo.inc";
exit;
}
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txBloqueioDeArquivo; ?></span></td>
              </tr>
			  <tr> 
                <td class="subMenuOver" onClick="location='alterar_bloqueio_arquivo.php'"><a href="alterar_bloqueio_arquivo.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
             <tr> 
                <td class="td">&nbsp;</td>
		   ...
		   <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
			...
			<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr align="left" class="tdAdmin"> 
                <td width="100%" align="center" class="txtBold"><? echo $txBloqueioDeArquivo; ?></td>
              </tr>
              <tr> 
                  <td height="14"><? echo $txObrigarABAPDF; if ($sucesso!="") { echo ": ".$arBloqueioNecessario; }?></td>
              </tr>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                      <tr> 
                          <td height="34" align="left" valign="bottom"> 
                            ...
                            <input type="radio" name="arBloqueioNecessarioA" value="Sim" <? if ($arBloqueioNecessario=="Sim") { echo "checked"; }?>><? echo $txSim; ?>
                            <input name="arBloqueioNecessarioA" type="radio" value="Nao" <? if ($arBloqueioNecessario=="Nao") { echo "checked"; }?>><? echo $txNao; ?></td>
                      </tr>
                      <tr> 
                        <td height="30" align="right" valign="bottom"><input name="Submit" type="submit" class="botao" value="<? echo $txAlterar; ?> &raquo;"> 
                        </td>
                      </tr>
