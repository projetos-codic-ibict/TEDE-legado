        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver"><a href="visualizar_prog.php?v=Editar" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?> </a></td>
              </tr>
              <tr> 
                <td class="subMenuOut">&nbsp;</td>
              </tr>
              <tr> 
		  ...
		  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">				   
                  <tr class="tdAdmin">
                        <td colspan="5" align="center" class="txtBold"><span class="txtBold"><? echo $txProgramaDePG; ?></span></td>
                  </tr>
                  <?
...
if ($SEL_pr_RES=="") {
                  ...
                  <tr class="tdOperacoes">
                        <td colspan="5" class="txtBold"><span class="txtBold"><? echo $txNenhumRegistroC; ?></span></td>
                  </tr>
<? } else {
$SEL_pr_st="SELECT * FROM Programa WHERE prStatus='INATIVO'";
$SEL_pr_st_query=mysql_db_query($base,$SEL_pr_st,$conexao);
$SEL_pr_st_RES=mysql_fetch_array($SEL_pr_st_query);

?>
                  <tr>
                    <td width="140" align="left" valign="middle"><span class="txtBold"><? echo $txNome; ?></span></td>
                    <td width="160" align="left" valign="middle"><span class="txtBold"><? echo $txBiblioteca; ?></span></td>
                    <td width="100" align="left" valign="middle"><span class="txtBold"><? echo $txArea; ?></span></td>
					<? if ($SEL_pr_st_RES!="") { ?>
				...
				$prStatus=strtolower($SEL_pr_RES["prStatus"]);
				$prStatus=ucwords($prStatus);
				...
				$SEL_bd="SELECT bdNome FROM BibliotecaDepositaria WHERE bdCod='$bdCod'";
				$SEL_bd_query=mysql_db_query($base,$SEL_bd,$conexao);
				$SEL_bd_RES=mysql_fetch_array($SEL_bd_query);
				$bdNome=$SEL_bd_RES["bdNome"];
		?>
		    <tr>
                    <td align="left" valign="middle" class=<? echo $estiloTR; ?>><? echo $prNome;?></td>
                    <td align="left" valign="middle" class=<? echo $estiloTR; ?>><? echo $bdNome;?></td>
                    <td align="left" valign="middle" class=<? echo $estiloTR; ?>><? echo $prArea;?></td>
					<? if ($SEL_pr_st_RES!="") { ?>
                    <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>>
                          <? if ($prStatus=="Inativo") { echo "<img src=\"../tde_layout1/imagens/inativo.gif\" alt=\"inativo\" hspace='0' vspace='0' border='0' align=\"absmiddle\"/>"; }?></td>
						  <? } ?>
                   
                    <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="editar_prog.php?prCod=<? echo $prCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
