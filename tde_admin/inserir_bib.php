      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td height="12" class="subMenuOver" onClick="location='inserir_bib.php'"><a href="inserir_bib.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?> </a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_bib.php?v=Editar'"><a href="visualizar_bib.php?v=Editar" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?> </a></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
			  ...
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr class="txt"> 
                          <td width="15%" class="txtBold"><span class="txtBold"><? echo $txNome; ?></span></td>
                        <td width="85%"><input name="bdNome" type="text" class="req" id="bdNome" value="<? echo $bdNome;?>" size="60" maxlength="255"></td>
                      </tr>
                      <tr class="txt"> 
                          <td class="txtBold"><span class="txtBold"><? echo $txSigla; ?></span></td>
                        <td><input name="bdSigla" type="text" class="req" id="pfCitacao2" value="<? echo $bdSigla;?>" size="32" maxlength="30"></td>
                      </tr>
                      <tr class="txt"> 
                          <td class="txtBold"><span class="txtBold"><? echo $txURL; ?></span></td>
                        <td><input name="bdURL" type="text" class="input" id="pfLattes2" value="<? echo $bdURL;?>" size="40" maxlength="150"></td>
                      </tr>
                      <tr class="txt"> 
