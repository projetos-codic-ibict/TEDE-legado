...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | ADMINISTRA&Ccedil;&Atilde;O | Visualiza&ccedil;&atilde;o da Biblioteca Digital</title>
<!-- InstanceEndEditable --> 
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
			...
			header("Location:inserir_bib_dig.php");
              ...
              <? } ?>
              <tr> 
                <td class="subMenuOver" onClick="location='visualizar_bib_dig.ph'"><a href="visualizar_bib_dig.php" class="linkpreto">&raquo; 
          ...
          <td height="100%" valign="top" class="tdConteudo"> 
			...
			<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td width="90%" height="85"><table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                    <? require "../conexao/conexao_fim.inc";
...
$SEL_bb_RES=mysql_fetch_array($SEL_bb_query);
				...
				?>
                    <tr class="tdAdmin">
                      <td colspan="2" align="center"><span class="txtBold"><? echo $txBibliotecaDigital; ?></span></td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      <td width="50" bgcolor="#FFFFFF" class="txtBold"><? echo $txSigla; ?></td>
                      <td bgcolor="#FFFFFF"><? echo $bbSigla;?></td>
                    </tr>
                    <tr> 
                      <td width="50" bgcolor="#FFFFFF" class="txtBold"><? echo $txURL; ?>&nbsp; </td>
                      <td bgcolor="#FFFFFF"><? echo $bbURL;?></td>
                    </tr>
                  </table></td>
              </tr>
            </table></div>
