...
require "biblioteca/envia_conta_admin.inc";
}
}
?>
            ...
            <table width="700" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td width="92%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td height="67" align="left" valign="top"> <p class="loginTableTitle"><b><? echo $txAdministracao; ?></b>: 
                          <b><? if ($enviar_senha==1) { echo $txEnviarSenha; }else{ echo $txLogin; }?></b> 
                        <p class="txtBold"><? if ($enviar_senha==1) { echo $txEntreLoginParaES; }else{ echo $txLoginParaAdminSist; }?></p>					    
					  <? echo $erro; echo $erro1; echo $erro2; echo $erro3;?>					  
					  </td>
                    </tr>
                    <tr> 
                      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="txt">
                          <tr> 
                            <td><form name="form1" method="post" action="" onSubmit="return checkForm(this.name); return true;">
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="txt">
                                  <tr> 
                                  ...
                                  </tr><? if ($enviar_senha!=1) {?>
                                  <tr> 
                                    <td width="20" height="30" align="center" valign="middle"><img src="../tde_layout1/imagens/arrow.gif" width="7" height="7"></td>
                                    <td width="106" height="30" valign="middle"><b><? echo $txSenha; ?></b></td>
                                    <td height="30"><input name="cnSenha" type="password" class="req" size="15" maxlength="30"></td>
                                    <td width="60" height="30">&nbsp;</td>
                                  </tr><? } ?>
                                  <tr>
                                    <td height="30"><input type="hidden" name="enviar_senha" value="<? echo $enviar_senha; ?>"></td>
                                    ...
                                    <td height="30" align="right" valign="bottom">
                                      <? if ($enviar_senha==1) {?>
                                      <a href="login.php" class="linkpreto"><? echo $txLoginParaAdminSist; ?> 
                                      &raquo;</a> 
                                      <? } else{ ?>
                            ...
                            <td width="280" align="left" valign="middle"><? echo $txEntreLogin; ?>.</td>
                          </tr>
                        </table></td>
                    </tr>
                </table>
