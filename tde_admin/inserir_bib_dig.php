 ...
 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
			...
			if ($SEL_bb_RES!="") {
			header("Location:visualizar_bib_dig.php");
            } else { ?>
              <tr> 
                <td height="12" class="subMenuOver" onClick="location='inserir_bib_dig.php'"><a href="inserir_bib_dig.php" class="linkvermelho">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
			  <? } ?>
              <tr> 
                <td height="13" class="td">&nbsp;</td>
              </tr>
              <tr> 
                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdAdmin"> 
                          <td height="19" colspan="2" class="txtBold"><? echo $txBibliotecaDigital; ?></td>
                      </tr>
                      <tr class="txt"> 
                        <td width="15%" class="txtBold"><? echo $txNome; ?></td>
                        <td width="85%"><input name="bbNome" type="text" class="req" value="<? echo $bbNome;?>" size="60" maxlength="255"></td>
                      </tr>
                      <tr class="txt"> 
                        <td class="txtBold"><? echo $txSigla; ?></td>
                        <td><input name="bbSigla" type="text" class="req" value="<? echo $bbSigla;?>" size="32" maxlength="30"></td>
                      </tr>
                      <tr class="txt"> 
                        <td class="txtBold"><? echo $txURL; ?></td>
                        <td><input name="bbURL" type="text" class="req" id="bbURL"  value="<? echo $bbURL;?>" size="40" maxlength="150"></td>
                      </tr>
                      <tr class="txt"> 
                        <td><input name="cod" type="hidden" value="Inserir"></td>
                        <td align="right" valign="bottom"><input name="Inserir" type="submit" class="botao" value="<? echo $txInserir; ?> &raquo;"></td>
                      </tr>
                    </table></td>
                </tr>
              </table></div> <br>
