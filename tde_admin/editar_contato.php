...
require "../conexao/conexao.inc";
				...
				//Selecionar programa
				$SEL_ct="SELECT * FROM Contatos WHERE ctCod=$ctCod";
				...
				$ctDescricao=$SEL_ct_RES["ctDescricao"];
      ...
      <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139" height="100%" align="left" valign="top" class="subMenuAdmin"> <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='visualizar_contato.php?v=Editar'"><a href="visualizar_contato.php?v=Editar" class="linkpreto">&raquo; 
          ...
          <td height="100%" valign="top" class="tdConteudo"><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;">
			  ...
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                        <tr align="center" class="tdAdmin"> 
                          <td colspan="2" class="txtBold"><? echo $txContato; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td width="26%" class="txtBold"><? echo $txNome; ?></td>
                          <td width="74%"> <input name="ctNome" type="text" class="req" value="<? echo $ctNome;?>" size="60" maxlength="255"></td>
                        </tr>
                        <tr class="txt"> 
                        ...
                        <tr class="tdAdmin" > 
                          ...
                          <td><input name="ctDispEmail" type="radio" value="Sim" <? if ($ctDispEmail=="Sim") { 
						echo "checked"; }?>>
                            <? echo $txSim; ?> 
                            <input type="radio" name="ctDispEmail" value="Nao" <? if ($ctDispEmail=="Nao") { 
						echo "checked"; }?>>
                            <? echo $txNao; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td><input name="cod" type="hidden" value="Alterar"> 
                            <input name="ctCod" type="hidden" value="<? echo $ctCod; ?>"></td>
