...
<table width="100%" height="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="100%" align="left" valign="top"><!-- InstanceBeginEditable name="Conteudo da Pagina" --><table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	  <? if ($trocar=="Sim" and $expiracao!="") {
require "biblioteca/alterar_expiracao.inc";
exit;
}
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txExpiracaoContaAutor; ?></span></td>
              </tr>
			   <tr> 
                <td class="subMenuOver" onClick="location='alterar_expiracao.php'"><a href="alterar_expiracao.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
             <tr> 
                <td class="td">&nbsp;</td>
           ...
           <div>
		      <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr align="left" class="tdAdmin"> 
                  <td width="100%" align="center" class="txtBold"><? echo $txExpiracaoContaAutor; ?></td>
                </tr>
                <tr> 
                  <td height="14"><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;">
                      <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                        <tr> 
                          <td height="24" align="left" valign="middle"> <? echo $txPrazoAtual; ?>: 
                            <span class="sucesso"><? echo $validade; ?></span> 
                            <? echo $txMes_es; ?>.</td>
                        </tr>
                        <? if ($sucesso=="") { ?>
                        <tr>
                          <td height="34" align="left" valign="bottom"><span class="txtBold"><? echo $txAlterarPrazoExpiracao; ?></span></td>
                        </tr>
                        <tr> 
                          <td height="34" align="left" valign="bottom"> <? echo $txNovoPrazo; ?>&nbsp; 
                            <input name="expiracao" type="text" class="numero" id="expiracao" value="" size="3" maxlength="2" onKeyPress="Numero(this);">
                            <? echo $txMes_es; ?>
