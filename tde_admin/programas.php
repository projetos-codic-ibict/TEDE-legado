        ...
        <tr> 
          <td width="139" height="100%" align="left" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txPrograma; ?></span></td>
              </tr>
              <tr> 
          ...
          <td height="100%" valign="top" class="tdConteudo"><br>
            <table width="90%" height="120" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td height="28" align="center" valign="middle"> 
                <span class="loginAdmin"><? echo $txProgramasDoSistema; ?></span><br> </td>
              </tr>
            </table>
            <br>
          </td>
