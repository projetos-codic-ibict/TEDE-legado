			...
			<table width="90%"  border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        <tr class="tdAdmin"> 
                          <td colspan="2" align="center" class="txtBold"><strong><? echo $txContaPosG; ?></strong></td>
                        </tr>
                        <tr> 
				...
				echo $SEL_pr_RES["prNome"];
                        ...
                        <tr> 
                          ...
                          <td width="84%" height="20"><? echo $cnNome; ?></td>
                        </tr>
                        <tr> 
                          <td height="20" class="txtBold"><? echo $txLogin; ?></td>
                          <td height="20"><? echo $cnLogin; ?></td>
                        </tr>
                        <tr> 
                          <td height="20" class="txtBold"><? echo $txEMail; ?></td>
                          <td height="20"><? echo $cnEmail; ?></td>
                        </tr>
                        <tr class="tdAdmin">
                          <td height="20"><strong><? echo $txStatus; ?></strong></td>
                          <td height="20">&nbsp;</td>
                        </tr>
                        <tr class="tdAdmin"> 
