...
<title>| Sistema de Sumiss&atilde;o de Teses e Disserta&ccedil;&otilde;es Eletr&ocirc;nicas 
| ADMINISTRA&Ccedil;&Atilde;O | Programas</title>
<!-- InstanceEndEditable --> 
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='inserir_prog.php'"><a href="inserir_prog.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_prog.php?v=Editar'"><a href="visualizar_prog.php?v=Editar" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
          ...
          <td height="100%" valign="top" class="tdConteudo"><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;">
              ...
              <tr> 
                  <td align="center" valign="middle"> <? echo $erro;if ($sucesso!="") {
					  echo $sucesso;
					  exit; } ?>                  
                  </td>
              </tr>
                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdAdmin"> 
                        <td colspan="2"><span class="txtBold"><? echo $txProgramaDePG; ?></span></td>
                      </tr>
                      <tr class="txt"> 
                        <td width="95" height="30" class="txtBold"><? echo $txNome; ?></td>
                        <td width="442" height="30"><input name="prNome" type="text" value="<? echo $prNome;?>" class="req" id="prNome" size="60" maxlength="255">
                        </td>
                      </tr>
                      <tr class="txt"> 
                        <td width="95" height="30" class="txtBold"><? echo $txArea; ?></td>
                        <td height="30"><input name="prArea" type="text" class="req" id="prArea" value="<? echo $prArea;?>" size="60" maxlength="200"></td>
                      </tr>
                      <tr class="txt"> 
                        <td width="95" height="30" class="txtBold"><? echo $txBibliotecaDepositaria; ?></td>
                        <td height="30"><select name="bdCod" id="bdCod" class="select">
...
$SEL_bd_RES=mysql_fetch_array($SEL_bd_query);
				...
				$bdSigla=$SEL_bd_RES["bdSigla"];
				 ...
				 ?>
                      ...
                      <tr class="txt"> 
                        <td width="95"><input name="cod" type="hidden" value="Inserir"></td>
                        <td align="right"><input name="<? echo $txInserir; ?>" type="submit" class="botao" value="<? echo $txInserir; ?> &raquo;"></td>
                      </tr>
                    </table></td>
                </tr>
              </table></div>
