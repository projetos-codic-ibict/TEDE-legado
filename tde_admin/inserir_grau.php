...
if ($cod!="") {
require "biblioteca/manutencao_grau.inc";
}
?>
      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txGrau; ?></span></td>
              </tr>
              <tr> 
                <td height="12" class="subMenuOver" onClick="location='inserir_grau.php'"><a href="inserir_grau.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?> </a></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
          ...
          <td height="100%" valign="top" class="tdConteudo"><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;" >
			  ...
			  <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td align="center" valign="middle"> <? echo $erro;
					  if ($sucesso!="") {
					   echo $sucesso;
					  exit; }?>                    
                  </td>
			  ...
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                ...
                <tr class="tdAdmin"> 
                    <td align="center"><span class="txtBold"><? echo $txBibliotecaDepositaria; ?></span></td>
                </tr>
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr class="txt">
                        <td colspan="2" class="txtBold"><div align="center"><? echo $txInserirGrau; ?></div></td>
                        </tr>
                      <tr class="txt">
                        <td class="txtBold">&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr class="txt"> 
                          <td width="15%" class="txtBold"><span class="txtBold"><? echo $txGrau; ?></span></td>
                          <td width="85%"><input name="txGrau" type="text" id="txGrau" size="20"></td>
                      </tr>
                      <tr class="txt"> 
                          <td class="txtBold">&nbsp;</td>
                          <td>&nbsp;</td>
			  ...
			  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr>
                  <td><table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                      <tr class="tdAdmin">
                        <td colspan="4" align="center" class="txtBold"><? echo $txGrauNaBase; ?></td>
                      </tr>
...
if ($SEL_gr_RES!="")  { 
$grCod=$SEL_gr_RES["grCod"];
$grNome=$SEL_gr_RES["grNome"];
$grIdimaPais=$SEL_gr_RES["grIdiomaPais"];
...
?>
				...
				?>
                      <tr>
                        <td class=<? echo $estiloTR; ?>><? echo $grNome;?></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>>&nbsp;<? if ($grCod>7) { ?>
                          <a href="excluir_conta_pos.php?cnCod=<? echo $cnCod; ?>" class="linkvermelho"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a> </td>
                       <? } ?>
                      </tr>
