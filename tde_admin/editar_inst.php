...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | ADMINISTRA&Ccedil;&Atilde;O | Edi&ccedil;&atilde;o da Institui&ccedil;&atilde;o do Sistema</title>
<!-- InstanceEndEditable --> 
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
			...
			if ($SEL_inst_RES=="") {
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='editar_inst.php'"><a href="editar_inst.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
              <? } ?>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_inst.php'"><a href="visualizar_inst.php" class="linkpreto">&raquo; 
          ...
          <td height="100%" valign="top" class="tdConteudo"><br> 
            <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td width="90%"><form name="form1" method="post" action="" onSubmit="return checkForm(this.name); return true;">
                  <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                    <? //Selecionar biblioteca
					 if ($inPais=="") {
$SEL_in="SELECT * FROM Instituicao WHERE inCod=1";
...
$SEL_in_RES=mysql_fetch_array($SEL_in_query);
				...
				?>
                    <tr class="tdAdmin">
                      <td colspan="2" align="center" class="txtBold"><? echo $txInstituicaoDoSistema; ?></td>
                      </tr>
                    <tr>
                      <td width="14%" class="txtBold"><? echo $txNome; ?></td>
                      <td width="86%">
                        <input name="inNome" type="text" class="req" id="inNome12" value="<? echo $inNome;?>" size="60" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td height="19" bgcolor="#FFFFFF" class="txtBold"><? echo $txSigla; ?></td>
                      <td height="19" bgcolor="#FFFFFF"><input name="inSigla" type="text" class="req" id="inSigla" value="<? echo $inSigla;?>" size="25" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td height="22" bgcolor="#FFFFFF" class="txtBold"><? echo $txPais; ?></td>
                        <td height="22" bgcolor="#FFFFFF"> 
						 ...
						 <? $SEL_ps="SELECT * FROM Pais WHERE psIdiomaPais='$idioma_sistema' ORDER BY psNome";
							...
							?>
                            <option value="<? echo $psSigla; ?>" <? if ($psSigla==$inPais) {?>selected<? } ?>><? echo $psNome; ?></option>
                            <? $SEL_ps_RES=mysql_fetch_array($SEL_ps_query);
						   }
						   ?>
                          </select> </td>
                    ...
                    <tr>
                      <td height="19" bgcolor="#FFFFFF" class="txtBold"><? echo $txUF; ?></td>
						...
						?>
                          <select name="inUF" class="select">
							...
							?>
                            <option value="<? echo $ufSigla; ?>" <? if ($ufSigla==$inUF) {?>selected<? } ?>><? echo $ufNome; ?></option>
                            <? $SEL_uf_RES=mysql_fetch_array($SEL_uf_query);
						   }
						   ?>
						   <option value="-" <? if ($inUF=="-") {?>selected<? } ?>>Nenhum acima</option>
                          </select> </td>
                    </tr>
                    <tr>
                      <td height="19" bgcolor="#FFFFFF" class="txtBold"><? echo $txCNPJ; ?></td>
                      <td height="19" bgcolor="#FFFFFF"><? $qtdCNPJcampo=$qtdCNPJ+1;
                    ...
                    <tr>
                      <td height="23" bgcolor="#FFFFFF" class="txtBold"><? echo $txURL; ?>&nbsp; </td>
                      <td height="23" bgcolor="#FFFFFF"><input name="inURL" type="text" class="req" id="inURL2" value="<? echo $inURL;?>" size="40" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td height="23" bgcolor="#FFFFFF"><input name="cod" type="hidden" value="Editar">
                      </td>
                      <td height="23" align="right" bgcolor="#FFFFFF">                          <input name="Editar" type="submit" class="botao" id="Editar" value="<? echo $txAlterar; ?> &raquo;">                                              </td>
                    </tr>
                  </table>
                </form></td>
              </tr>
