      ...
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td height="100%" valign="top">
            ...
            <? } ?>
            <br>
            <table width="90%" height="110" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr> 
                <td height="59" align="center" valign="middle" class="loginAdmin"><? echo $txBibliotecaDepositaria; ?></td>
              </tr>
            </table>
            <br>
          </td>
