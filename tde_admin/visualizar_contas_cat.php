...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | ADMINISTRA&Ccedil;&Atilde;O | Inserir Biblioteca Digital</title>
...
<tr> <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            ...
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td height="13" class="subMenuOver" onClick="location='visualizar_contas_cat.php?v=Edita'"><a href="visualizar_contas_cat.php?v=Editar" class="linkpreto">&raquo; 
		   ...
		   <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
			...
			<table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdAdmin"> 
                        <td colspan="5" class="txtBold"><span class="txtBold"><? echo $txContaCatalogador; ?></span></td>
                      </tr>
                      <?
...
$SEL_cn="SELECT * FROM Contas WHERE cnTipo='Catalogador' or cnTipo='MasterCataloga' ORDER BY cnNome";
...
if ($SEL_cn_RES=="") {					
					?>
                      <tr class="tdOperacoes"> 
                        <td height="14" colspan="5"><span class="txtBold"><? echo $txNenhumRegistroC; ?>.</span></td>
                      </tr>
                      <? } else {
$SEL_cn_st="SELECT * FROM Contas WHERE (cnTipo='Catalogador' or cnTipo='MasterCataloga') and cnBloqueado='1'";
$SEL_cn_st_query=mysql_db_query($base,$SEL_cn_st,$conexao);
$SEL_cn_st_RES=mysql_fetch_array($SEL_cn_st_query);
					  ?>
                      <tr> 
                        <td width="119" height="14"><span class="txtBold"><? echo $txLogin; ?></span></td>
                        <td width="201"><span class="txtBold"><? echo $txBiblioteca; ?></span></td>
                        <? if ($SEL_cn_st_RES!="") { ?>
				...
				?>
                      <tr> 
                        ...
                        <td class="<? echo $estiloTR;?>"><? echo $bdNome;?></td>
                        <? if ($SEL_cn_st_RES!="") { ?>
						
                        <td width="50" align="center" valign="middle" class="<? echo $estiloTR;?>">&nbsp; 
						<? if ($cnBloqueado=="1") { echo "<img src=\"../tde_layout1/imagens/cadeado.gif\" alt=\"bloqueado\" hspace='0' vspace='0' border='0' align=\"absmiddle\"/>"; } ?> 
                        </td>
                        <? } ?>
                        <td width="50" align="center" valign="middle" class="<? echo $estiloTR;?>"><a href="editar_conta_cat.php?cod=Editar&cnCod=<? echo $cnCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center" valign="middle" class="<? echo $estiloTR;?>"><a href="excluir_conta_cat.php?cnCod=<? echo $cnCod; ?>" class="linkvermelho"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <? if ($EVcnCod=="$cnCod") { ?>
                      <tr> 
