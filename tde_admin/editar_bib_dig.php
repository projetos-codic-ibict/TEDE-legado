        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
			...
			header("Location:inserir_bib_dig.php");
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='editar_bib_dig.php'"><a href="editar_bib_dig.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
              <? } ?>
              <tr> 
              ...
              <tr> 
                <td width="90%"><form name="form1" method="post" action="" onSubmit="return checkForm(this.name); return true;">
                  <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                    <? if ($cod!="") {
							require "biblioteca/manutencao_bib_dig.inc";
							}
				require "../conexao/conexao_fim.inc";
				
//Selecionar biblioteca
$SEL_bb="SELECT * FROM BibliotecaDigital WHERE bbCod=1";
$SEL_bb_query=mysql_db_query($base_fim,$SEL_bb,$conexao_fim);
$SEL_bb_RES=mysql_fetch_array($SEL_bb_query);
		
				$bbCod=$SEL_bb_RES["bbCod"];
				$bbNome=$SEL_bb_RES["bbNome"];
				$bbSigla=$SEL_bb_RES["bbSigla"];
				$bbURL=$SEL_bb_RES["bbURL"];
				?>
                    <tr class="tdAdmin">
                      <td colspan="2" align="center" class="txtBold"><? echo $txBibliotecaDigital; ?></td>
                      </tr>
                    <tr>
                      <td width="50" height="30" align="left" valign="middle" class="txtBold"><? echo $txNome; ?></td>
                      <td height="30" align="left" valign="middle">
                        <input name="bbNome" type="text" class="req" id="inNome12" value="<? echo $bbNome;?>" size="60" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td width="50" height="30" align="left" valign="middle" class="txtBold"><? echo $txSigla; ?></td>
                      <td height="30" align="left" valign="middle"><input name="bbSigla" type="text" class="req" id="bbSigla" value="<? echo $bbSigla;?>" size="25" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td width="50" height="30" align="left" valign="middle" class="txtBold"><? echo $txURL; ?></td>
                      <td height="30" align="left" valign="middle"><input name="bbURL" type="text" class="req" id="inURL2" value="<? echo $bbURL;?>" size="40" maxlength="150">
                      </td>
                    </tr>
                    <tr>
                      <td width="50" height="33" align="left" valign="middle"><input name="cod" type="hidden" value="Editar">
                      </td>
                      <td align="right" valign="bottom"><input name="Editar" type="submit" class="botao" id="Editar" value="<? echo $txAlterar; ?> &raquo;">
</td>
                    </tr>
                  </table>
                </form></td>
