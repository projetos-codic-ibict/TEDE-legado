          ...
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
			  ...
			  <!-- esta TD precisa ser reestruturada para poder inserir o link -->
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='editar_inst.php'">
			...
			header("Location:inserir_inst.php");
                  ...
                  <a href="editar_inst.php" class="linkpreto">&raquo; <? echo $txAlterar; ?></a></td>
              </tr>
              <? } ?>
              <tr> 
                <td class="subMenuOver" onClick="location='visualizar_inst.php'"><a href="visualizar_inst.php" class="linkpreto">&raquo; <? echo $txVisualizar; ?></a></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
              </tr>
...
$SEL_uf="SELECT ufNome FROM UnidadeFederativa WHERE ufSigla='$inUF'";
...
$ufNome=$SEL_uf_RES['ufNome'];
				?>
                    <tr align="center" class="tdAdmin"> 
                        <td colspan="2" class="txtBold"><span class="txtBold"><? echo $txInstituicaoDoSistema; ?></span></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" class="txtBold"><? echo $txNome; ?></td>
                      <td align="left" valign="middle"><? echo $inNome;?></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" class="txtBold"><? echo $txSigla; ?></td>
                      <td align="left" valign="middle"><? echo $inSigla;?></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" bgcolor="#FFFFFF" class="txtBold"><? echo $txPais; ?></td>
                      <td align="left" valign="middle" bgcolor="#FFFFFF"><? echo $psNome;?></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" class="txtBold"><? echo $txUF; ?></td>
                      <td align="left" valign="middle"><? echo $ufNome;?></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" bgcolor="#FFFFFF" class="txtBold"><? echo $txCNPJ; ?></td>
                      <td align="left" valign="middle" bgcolor="#FFFFFF"><? echo $inCNPJ;?></td>
                    </tr>
                    <tr> 
                        <td width="50" align="left" valign="middle" class="txtBold"><? echo $txURL; ?>&nbsp; 
                        </td>
                      <td align="left" valign="middle"><? echo $inURL;?></td>
                    </tr>
                  </table></td>
              </tr>
            </table></div>
