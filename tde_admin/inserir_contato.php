...
if ($cod!="") {
require "biblioteca/manutencao_contato.inc";
}
?>
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver"><a href="inserir_contato.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_contato.php?v=Editar'"><a href="visualizar_contato.php?v=Editar" class="linkpreto">&raquo; 
                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                        <tr align="center" class="tdAdmin"> 
                          <td height="15" colspan="2" class="txtBold"><? echo $txContato; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td width="17%" height="19" class="txtBold"><? echo $txNome; ?></td>
                          <td width="83%"><input name="ctNome" type="text" class="req" value="<? echo $ctNome;?>" size="60" maxlength="255"></td>
                        </tr>
                        <tr class="txt"> 
                          <td class="txtBold"><? echo $txEMail; ?></td>
                          <td><input name="ctEmail" type="text" class="email" value="<? echo $ctEmail;?>" size="50" maxlength="30"></td>
                        </tr>
                        <tr class="txt"> 
                          <td class="txtBold"><? echo $txDescricao; ?></td>
                          <td><textarea name="ctDescricao" cols="50" rows="3" class="input" id="ctDescricao"><? echo $ctDescricao; ?></textarea></td>
                        </tr>
                        <tr class="tdAdmin"> 
                          <td colspan="2"><strong><? echo $txStatus; ?></strong></td>
                        </tr>
                        <tr class="tdAdmin"> 
                          <td><? echo $txDisponivel; ?></td>
                          <td><input name="ctDispEmail" type="radio" value="Sim" checked>
                            <? echo $txSim; ?> 
                            <input type="radio" name="ctDispEmail" value="Nao">
                            <? echo $txNao; ?></td>
                        </tr>
                        <tr class="txt"> 
                          <td><input name="cod" type="hidden" value="Inserir"></td>
                          <td align="right"><input name="Inserir" type="submit" class="botao" value="<? echo $txInserir; ?> &raquo;"></td>
                        </tr>
                      </table></td>
                </tr>
              </table></div>
