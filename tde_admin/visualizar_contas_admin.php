...
<title>| Sistema de Publica&ccedil;&atilde;o Eletr&ocirc;nica de Teses e Disserta&ccedil;&otilde;es | ADMINISTRA&Ccedil;&Atilde;O | Contas da Administra&ccedil;&atilde;o</title>
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txContaAdministracao; ?></span> 
                </td>
              </tr>
              <tr> 
		   ...
		   <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
			 ...
			 <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdAdmin"> 
                        <td colspan="4" class="txtBold"><span class="txtBold"><? echo $txContaAdministracao; ?></span></td>
                      </tr>
                      <?
...
$SEL_cn="SELECT * FROM Contas WHERE cnTipo='Administrador' ORDER BY cnNome";
...
if ($SEL_cn_RES=="") {
				?>
                      ...
                      <? } else {
$SEL_cn_st="SELECT * FROM Contas WHERE cnTipo='Administrador' and cnBloqueado='1'";
$SEL_cn_st_query=mysql_db_query($base,$SEL_cn_st,$conexao);
$SEL_cn_st_RES=mysql_fetch_array($SEL_cn_st_query);
					  
					  ?>
                      <tr> 
                        <td width="276"><span class="txtBold"><? echo $txLogin; ?></span></td>
                        <? if ($SEL_cn_st_RES!="") { ?>
...
if ($cnCod=="$EVcnCod") {
				...
				?>
                      <tr> 
                        <td height="32" class=<? echo $estiloTR; ?>><? echo $cnLogin;?></td>
                        <? if ($SEL_cn_st_RES!="") { ?>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>> &nbsp; 
                          <? if ($cnBloqueado=="1") {  echo "<img src=\"../tde_layout1/imagens/cadeado.gif\" alt=\"bloqueado\" hspace='0' vspace='0' border='0' align=\"absmiddle\"/>";  } ?> </td>
                        <? } ?>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="editar_conta_admin.php?cod=Editar&cnCod=<? echo $cnCod; ?>" class="linkpreto"><img src="../tde_layout1/imagens/alterar.gif" / alt="alterar" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                        <td width="50" align="center" valign="middle" class=<? echo $estiloTR; ?>><a href="excluir_conta_admin.php?cnCod=<? echo $cnCod; ?>" class="linkvermelho"><img src="../tde_layout1/imagens/excluir.gif" / alt="excluir" hspace="0" vspace="0" border="0" align="absmiddle"></a></td>
                      </tr>
                      <? if ($EVcnCod=="$cnCod") { ?>
                      <tr> 
                        <td colspan="2" class=<? echo $estiloTR; ?>><span class="txtBold"><? echo $txNome; ?></span><br> 
                          <? echo $cnNome; if ($cnEmail!="") {?> <br> <span class="txtBold"><? echo $txEMail; ?></span><br> 
                          <? echo $cnEmail; } ?> </td>
						 <? if ($SEL_cn_st_RES!="") { ?>
