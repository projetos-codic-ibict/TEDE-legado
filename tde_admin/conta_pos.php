...
<title>| Sistema de Sumiss&atilde;o de Teses e Disserta&ccedil;&otilde;es Eletr&ocirc;nicas | ADMINISTRA&Ccedil;&Atilde;O | Conta da P&oacute;s-Gradua&ccedil;&atilde;o</title>
<!-- InstanceEndEditable --> 
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='conta_pos.php'"><a href="conta_pos.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_contas_pos.php?v=Editar'"><a href="visualizar_contas_pos.php?v=Editar" class="linkpreto">&raquo; 
              ...
              <table width="90%"  border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      ...
                      <tr> 
                        <td width="16%" class="txtBold"><? echo $txPrograma; ?></td>
                        <td width="84%"><select name="prCod" id="prCod" class="select">
                            
                            <option value="">Seleciona</option>
                            <? $SEL_pr="SELECT * FROM Programa WHERE prStatus!='INATIVO'  ORDER BY prNome";
...
$SEL_pr_RES=mysql_fetch_array($SEL_pr_query);
				...
				$prNome=$SEL_pr_RES["prNome"];
											?>
                            <option value="<? echo $prCod.','.$prNome;?>" <? if ($prCod==$prCodL) { echo "Selected"; } ?>><? echo $prNome;?></option>
                            <? $SEL_pr_RES=mysql_fetch_array($SEL_pr_query); }
				 ?>
                          </select></td>
                      </tr>
...
<? echo $txNao; ?></td>
                      ...
                      <tr> 
                        <td><input name="cnTipo" type="hidden" value="Pos"> <input name="cod" type="hidden" value="Inserir"></td>
