                ...
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      <tr align="center" class="tdAdmin"> 
                        <td colspan="2"><span class="txtBold"><? echo $txContato; ?></span></td>
                      </tr>
                      <tr class="txt"> 
                        <td width="26%" class="txtBold"><? echo $txNome; ?></td>
                        <td width="74%"><? echo $ctNome;?></td>
                      </tr>
                      <tr class="txt"> 
                      ...
                      <tr class="tdAdmin"> 
                        ...
                        <td><? echo $ctDispEmail;?></td>
                      </tr>
                      <tr class="txt"> 
                        <td><input name="cod" type="hidden" value="Excluir"> <input name="ctCod" type="hidden" value="<? echo $ctCod; ?>"></td>
