            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_prog.php?v=Editar'"><a href="visualizar_prog.php?v=Editar" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a>/<? echo $txExcluir; ?></td>
              </tr>
              <tr> 
                <td class="td">&nbsp;</td>
              </tr>
			 ...
			 <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="txt">
                      ...
                      <tr class="txt"> 
                        <td><input name="cod" type="hidden" value="Excluir"> <input name="prCod" type="hidden" id="prCod2" value="<? echo $prCod; ?>"></td>
