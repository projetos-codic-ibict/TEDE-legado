...
if ($trocar=="Sim" and $ipPermitidoA!="") {
require "biblioteca/alterar_ip.inc";
exit;
}
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              <tr> 
                <td class="td"><span class="txtBold">&raquo; <? echo $txIPRestrito; ?></span></td>
              </tr>
			  <tr> 
                <td class="subMenuOver" onClick="location='alterar_ip_restrito.php'"><a href="alterar_ip_restrito.php" class="linkpreto">&raquo; 
                  <? echo $txAlterar; ?></a></td>
              </tr>
             <tr> 
                <td class="td">&nbsp;</td>
		   ...
		   <table width="90%" height="60" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
			...
			<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
              <tr align="left" class="tdAdmin"> 
                <td width="100%" align="center" class="txtBold"><? echo $txIPRestrito; ?></td>
              </tr>
              <tr class="txtBold"> 
                  <td height="14"><? echo $txIPPermitidosVADAR; ?></td>
              </tr>
              ...
              <tr> 
                <td height="14"><? if ($sucesso=="") { ?><form name="form" action="" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this.name); return true;" >
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt">
                      <tr> 
                          <td height="34" align="left" valign="bottom"><? echo $txIPPermitidos; ?>
                            <input name="ipPermitidoA" type="text" class="req" id="ipPermitidoA" value="<? echo $ipPermitido; ?>" size="40">
                          <input name="trocar" type="hidden" id="trocar" value="Sim">
                            <br>
                            <? echo $txIPSepararExemplo; ?></td>
                      </tr>
                      <tr> 
                  ...
                  </form> <? } else{  echo "<span class=\"sucesso\">".$ipPermitido."</span>"; } ?></td>
              </tr>
            </table></div>
            <br>
          </td>
