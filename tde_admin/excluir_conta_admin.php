			  ...
			  <table width="90%"  border="0" align="center" cellpadding="5" cellspacing="0" class="loginTable">
                <tr> 
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                        ...
                        <tr class="tdAdmin">
                          <td height="21"><strong><? echo $txStatus; ?></strong></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr class="tdAdmin"> 
                          <td height="21"><? echo $txBloqueado; ?></td>
                          <td> 
                            <? if ($cnBloqueado=="1") { echo "Sim"; } else { echo "Não"; } ?>
                          </td>
                        </tr>
                        <tr> 
                          <td><input name="cnTipo" type="hidden" value="Administrador"> 
                            <input name="cod" type="hidden" value="Excluir"> <input name="cnCod" type="hidden" id="cnCod2" value="<? echo $cnCod; ?>"></td>
                          <td align="right" valign="bottom"><input name="Excluir" type="submit" class="botao" id="Editar3" value="<? echo $txExcluir; ?> &raquo;"></td>
                        </tr>
                      </table></td>
                </tr>
              </table></div>
