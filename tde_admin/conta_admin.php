...
<title>| Sistema de Sumiss&atilde;o de Teses e Disserta&ccedil;&otilde;es Eletr&ocirc;nicas | ADMINISTRA&Ccedil;&Atilde;O | Conta do Administrador</title>
<!-- InstanceEndEditable --> 
        ...
        <tr> 
          <td width="139" height="100%" valign="top" class="subMenuAdmin"> 
            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="txt">
              ...
              <tr> 
                <td class="subMenuOver" onClick="location='conta_admin.php'"><a href="conta_admin.php" class="linkpreto">&raquo; 
                  <? echo $txInserir; ?></a></td>
              </tr>
              <tr> 
                <td class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='visualizar_contas_admin.php?v=Editar'"><a href="visualizar_contas_admin.php?v=Editar" class="linkpreto">&raquo; 
              ...
              <tr> 
                <td height="13" class="subMenuOut" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='tde_admin.php'"><a href="tde_admin.php" class="linkpreto">&laquo; 
                  <? echo $txMenuPrincipal; ?></a></td>
              </tr>
              <tr>
                <td height="13" onMouseOver="this.className='subMenuOver'" onMouseOut="this.className='subMenuOut'" onClick="location='tde_admin.php'">&nbsp;</td>
              </tr>
              <tr> 
                ...
                <tr> 
                  <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
                      ...
                      <tr> 
                        ...
                        <td width="84%"><input name="cnNome" type="text" class="req" id="cnNome2" value="<? echo $cnNome; ?>" size="50" maxlength="100"></td>
                      </tr>
                      <tr>
                      ...
                      <tr> 
                        ...
                        <td><input name="cnEmail" type="text" class="input" id="cnEmail2" value="<? echo $cnEmail; ?>" size="40" maxlength="100"></td>
                      </tr>
                      <tr class="tdAdmin"> 
...
<? echo $txNao; ?></td>
                      ...
                      <tr> 
                        <td><input name="cnTipo" type="hidden" id="cnTipo2" value="Administrador"> 
                          <input name="cod" type="hidden" value="Inserir"></td>
                        <td align="right" valign="bottom"><input name="Inserir" type="submit" class="botao" id="Inserir2" value="<? echo $txInserir; ?> &raquo;"></td>
                      </tr>
                  </table></td>
                </tr>
              </table>
