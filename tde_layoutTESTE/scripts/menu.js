...
var mySeparator=new Array ("tde_layout1/imagens/menuSep.gif","tde_layout1/imagens/menuSep_busca.gif","tde_layout1/imagens/menuSep_aluno.gif","tde_layout1/imagens/menuSep_pos.gif","tde_layout1/imagens/menuSep_biblio.gif","tde_layout1/imagens/menuSep_admin.gif","tde_layout1/imagens/menuSep_contato.gif");
//array de barras de menu (identificação de seção, para feedback ao usuário)
var myMenubar=new Array ("tde_layout1/imagens/menuTile.gif","tde_layout1/imagens/menuTile_busca.gif","tde_layout1/imagens/menuTile_aluno.gif","tde_layout1/imagens/menuTile_pos.gif","tde_layout1/imagens/menuTile_biblio.gif","tde_layout1/imagens/menuTile_admin.gif","tde_layout1/imagens/menuTile_contato.gif");
...
function overMenu (x,y) {
	document.menuSep.src=y+mySeparator[x]; //alterar para início (página inicial do pacote)
	document.menuBar.src=y+myMenubar[x]; //alterar separador do menu para o original		
}
