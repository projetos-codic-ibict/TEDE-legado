...
include_once('oai2/oaidp-config.php');
...
echo $xmlheader;
echo $request;
//echo utf8_decode(fix_utf8(utf8_encode($output)));
echo $output;
//echo "<!-- Memoria Utilizada: ".memory_get_usage()." -->\n";
//$DELTA_TEMPO=time()-$OAI_INICIO;
//echo "<!-- Tempo gasto : ".$DELTA_TEMPO." segundos -->\n";
oai_close(); 
//$DELTA_TEMPO=time()-$OAI_INICIO;
//echo "<!-- Tempo gasto : ".$DELTA_TEMPO." segundos -->\n";
