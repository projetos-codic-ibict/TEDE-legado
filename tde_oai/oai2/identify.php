...
//
// Exibição do description/toolkit para o pacote oai-pmh do TEDE.
//

if (true){
	global $versao_protocolo;
	global $versao;
	$output .= utf8_encode('<description>
   <toolkit xmlns="http://oai.dlib.vt.edu/OAI/metadata/toolkit" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://oai.dlib.vt.edu/OAI/metadata/toolkit
http://oai.dlib.vt.edu/OAI/metadata/toolkit.xsd">
	<title>Tede/IBICT</title>
	<author>
		<name>IBICT - Instituto Brasileiro de Informacao em Ciencia e Tecnologia</name>
		<email>bdtd_oai@ibict.br</email>
		<institution>IBICT - Instituto Brasileiro de Informacao em Ciencia e Tecnologia</institution>
	</author>
	<version>TEDE:'.$versao.' / PROTOCOLO:'.$versao_protocolo.'</version>
	<URL>http://tedesite.ibict.br</URL>
     </toolkit>
  </description>'."\n"); 
}
