...
//require_once('./biblioteca/mtdbr.php');
require_once('./biblioteca/IBICT.php');
...
////							'myhandler'=>'record_etdms.php',
//							'myhandler'=>'mtdbr2etdms',
//              'record_prefix'=>'thesys'
//            ), 
              'mtd-br' => array(
              'metadataPrefix'=>'mtd-br',
							'schema'=>'http://www.ibict.br/schema/mtd-br(v1.0).xsd',
							'metadataNamespace'=>'http://www.ibict.br/schema/',
...
// do not change
$oainav ='<?xml-stylesheet type="text/xsl" href="oainav.php" ?>';
...
$TEDE =& new OAI_MTDBR($mtdbr_sigla,$repositoryIdentifier.$delimiter,"1.0"); // Prefixo do identificador , versão MTD-BR
$TEDE_DC =& new OAI_MTDBR($mtdbr_sigla,$repositoryIdentifier.$delimiter,"oai_dc"); // Prefixo do identificador , OAI_DC
